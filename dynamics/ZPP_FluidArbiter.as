package zpp_nape.dynamics
{
   ...
   public class ZPP_FluidArbiter extends ZPP_Arbiter
   {
      ...
      // method body index: 3682 method index: 3978
      public static var zpp_pool:ZPP_FluidArbiter = // method body index: 3687 method index: 3992
      null;
      ...
      {
         // method body index: 3686 method index: 3977
      ...
      {
         // method body index: 3683 method index: 3982
         if(!active)
         {
      ...
      {
         // method body index: 3684 method index: 3983
         centroidx = param1.x;
         centroidy = param1.y;
      }
      ...
      {
         // method body index: 3685 method index: 3987
