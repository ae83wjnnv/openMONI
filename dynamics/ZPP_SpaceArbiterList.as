package zpp_nape.dynamics
{
   ...
   public class ZPP_SpaceArbiterList extends ArbiterList
   {
      ...
      {
         // method body index: 4453 method index: 4811
         var _loc2_:int = 0;
      ...
      {
         // method body index: 4444 method index: 4813
      ...
      {
         // method body index: 4445 method index: 4814
         var _loc1_:int = 0;
         var _loc2_:int = 0;
      ...
      {
         // method body index: 4446 method index: 4815
      ...
      {
         // method body index: 4447 method index: 4816
         Boot.lastError = new Error();
         throw "Error: ArbiterList is immutable";
      }
      ...
      {
         // method body index: 4448 method index: 4817
         Boot.lastError = new Error();
         throw "Error: ArbiterList is immutable";
      }
      ...
      {
         // method body index: 4449 method index: 4818
         Boot.lastError = new Error();
         throw "Error: ArbiterList is immutable";
      }
      ...
      {
         // method body index: 4450 method index: 4819
         Boot.lastError = new Error();
         throw "Error: ArbiterList is immutable";
      }
      ...
      {
         // method body index: 4451 method index: 4820
         Boot.lastError = new Error();
         throw "Error: ArbiterList is immutable";
      }
      ...
      {
         // method body index: 4452 method index: 4821
         var _loc4_:* = 0;
