package zpp_nape.dynamics
{
   ...
   public class ZPP_InteractionGroup
   {
      ...
      // method body index: 4316 method index: 4676
      public static var SHAPE:int = // method body index: 4321 method index: 4683
      1;
      
      public static var BODY:int = // method body index: 4321 method index: 4683
      2;
      ...
      {
         // method body index: 4320 method index: 4675
      ...
      {
         // method body index: 4317 method index: 4677
         if(group != param1)
         {
            if(group != null)
            {
      ...
      {
         // method body index: 4318 method index: 4678
         interactors.remove(param1);
      }
      
      public function invalidate(param1:Boolean = false) : void
      {
         // method body index: 4319 method index: 4680
