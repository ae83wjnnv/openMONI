package zpp_nape.phys
{
   ...
   public class ZPP_Body extends ZPP_Interactor
   {
      ...
      // method body index: 4221 method index: 4567
      public static var bodystack:ZNPList_ZPP_Body = // method body index: 4273 method index: 4632
      null;
      
      public static var bodyset:ZPP_Set_ZPP_Body = // method body index: 4273 method index: 4632
      null;
      
      public static var cur_graph_depth:int = // method body index: 4273 method index: 4632
      0;
      ...
      {
         // method body index: 4272 method index: 4566
         ...
         forcex = 0;
         forcey = 0;
         torque = angvel = Number(kinangvel = 0);
         pre_posx = 1.79e+308;
         pre_posy = 1.79e+308;
         pre_rot = 1.79e+308;
         localCOMx = 0;
      ...
      {
         // method body index: 4219 method index: 4630
         return param1.id < param2.id;
      }
      
      public static function __static() : Body
      {
         // method body index: 4220 method index: 4631
         ...
         _loc2_.smass = _loc2_.imass = Number(_loc2_.cmass = Number(_loc2_.mass = Number(_loc2_.gravMass = 0)));
         _loc2_.sinertia = _loc2_.iinertia = Number(_loc2_.cinertia = Number(_loc2_.inertia = 0));
      ...
      {
         // method body index: 4222 method index: 4568
      ...
      {
         // method body index: 4223 method index: 4569
      ...
      {
         // method body index: 4224 method index: 4570
         if(zip_worldCOM)
         {
            zip_worldCOM = false;
            validate_localCOM();
      ...
      {
         // method body index: 4225 method index: 4571
      ...
      {
         // method body index: 4226 method index: 4572
               ...
               if(_loc5_.zip_localCOM)
               {
                  ...
                  if(_loc5_.type == ZPP_Flags.id_ShapeType_POLYGON)
                  {
                     ...
                     else
                     {
                        ...
                        _loc11_ = _loc8_ = _loc6_.lverts.next;
                        _loc7_ += _loc10_.x * (_loc11_.y - _loc9_.y);
                        _loc12_ = _loc11_.y * _loc10_.x - _loc11_.x * _loc10_.y;
                        _loc6_.localCOMx += (_loc10_.x + _loc11_.x) * _loc12_;
                        _loc6_.localCOMy += (_loc10_.y + _loc11_.y) * _loc12_;
      ...
      {
         // method body index: 4227 method index: 4573
         var _loc2_:* = null as ZNPNode_ZPP_Shape;
         var _loc3_:* = null as ZPP_Shape;
         var _loc4_:Number = NaN;
         var _loc1_:Boolean = false;
      ...
      {
         // method body index: 4228 method index: 4574
      ...
      {
         // method body index: 4229 method index: 4575
         if(zip_gravMass)
         {
            zip_gravMass = false;
            validate_mass();
      ...
      {
         // method body index: 4230 method index: 4576
         if(zip_axis)
         {
            zip_axis = false;
            axisx = Math.sin(rot);
      ...
      {
         // method body index: 4231 method index: 4577
                              ...
                              if(_loc3_.zip_localCOM)
                              {
                                 ...
                                 if(_loc3_.type == ZPP_Flags.id_ShapeType_POLYGON)
                                 {
                                    ...
                                    else
                                    {
                                       ...
                                       _loc9_ = _loc6_ = _loc4_.lverts.next;
                                       _loc5_ += _loc8_.x * (_loc9_.y - _loc7_.y);
                                       _loc10_ = _loc9_.y * _loc8_.x - _loc9_.x * _loc8_.y;
                                       _loc4_.localCOMx += (_loc8_.x + _loc9_.x) * _loc10_;
                                       _loc4_.localCOMy += (_loc8_.y + _loc9_.y) * _loc10_;
      ...
      {
         // method body index: 4232 method index: 4580
      ...
      {
         // method body index: 4233 method index: 4581
         svelx = param1.x;
         svely = param1.y;
         wake();
      }
      ...
      {
         // method body index: 4234 method index: 4582
         if(space != null)
         {
      ...
      {
         // method body index: 4235 method index: 4583
      ...
      {
         // method body index: 4236 method index: 4584
         invalidate_shapes();
      }
      
      public function shapes_adder(param1:Shape) : Boolean
      {
         // method body index: 4237 method index: 4585
      ...
      {
         // method body index: 4238 method index: 4586
      ...
      {
         // method body index: 4239 method index: 4587
         var _loc4_:* = null as Vec2;
         var _loc5_:Boolean = false;
         var _loc6_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 4240 method index: 4588
      ...
      {
         // method body index: 4241 method index: 4589
         var _loc4_:* = null as Vec2;
         var _loc5_:Boolean = false;
         var _loc6_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 4242 method index: 4590
         var _loc4_:* = null as Vec2;
         var _loc5_:Boolean = false;
         var _loc6_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 4243 method index: 4591
         var _loc4_:* = null as Vec2;
         var _loc5_:Boolean = false;
         var _loc6_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 4244 method index: 4592
      ...
      {
         // method body index: 4245 method index: 4593
      ...
      {
         // method body index: 4246 method index: 4595
      ...
      {
         // method body index: 4247 method index: 4596
         var _loc2_:* = null as ZNPNode_ZPP_Shape;
         var _loc3_:* = null as ZPP_Shape;
      ...
      {
         // method body index: 4248 method index: 4597
      ...
      {
         // method body index: 4249 method index: 4598
         kinvelx = param1.x;
         kinvely = param1.y;
         wake();
      }
      ...
      {
         // method body index: 4253 method index: 4605
         zip_aabb = true;
         zip_localCOM = true;
         zip_worldCOM = true;
         invalidate_mass();
      ...
      {
         // method body index: 4254 method index: 4608
         if(massMode == ZPP_Flags.id_MassMode_DEFAULT)
         {
            zip_mass = true;
         }
      ...
      {
         // method body index: 4255 method index: 4610
      ...
      {
         // method body index: 4256 method index: 4611
      ...
      {
         // method body index: 4257 method index: 4612
      ...
      {
         // method body index: 4258 method index: 4614
         ...
         else
         {
            ...
            while(_loc11_ != null)
            {
               ...
               {
                  _loc11_.prev; //unpopped
               }
               else if(_loc11_.next != null)
               {
                  _loc11_.next; //unpopped
               }
               else
               {
                  _loc6_ = _loc11_.data;
      ...
      {
         // method body index: 4259 method index: 4615
         if(ZPP_Body.bodyset == null)
         {
            ZPP_Body.bodyset = new ZPP_Set_ZPP_Body();
            ZPP_Body.bodyset.lt = ZPP_Body.bodysetlt;
      ...
      {
         // method body index: 4260 method index: 4616
         if(shapes.head == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 4261 method index: 4617
         if(shapes.head == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 4262 method index: 4618
      ...
      {
         // method body index: 4263 method index: 4619
         if(type != ZPP_Flags.id_BodyType_DYNAMIC)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 4264 method index: 4621
      ...
      {
         // method body index: 4265 method index: 4622
         var _loc2_:* = null as ZNPNode_ZPP_Shape;
         var _loc3_:* = null as ZPP_Shape;
      ...
      {
         // method body index: 4266 method index: 4623
      ...
      {
         // method body index: 4267 method index: 4624
         var _loc5_:* = null as ZPP_Body;
         ...
         else
         {
            ...
            while(_loc9_ != null)
            {
               if(_loc9_.prev != null)
               {
                  _loc9_.prev; //unpopped
               }
               else if(_loc9_.next != null)
               {
                  _loc9_.next; //unpopped
               }
               else
               {
                  _loc5_ = _loc9_.data;
      ...
      {
         // method body index: 4268 method index: 4625
         ...
         svelx = 0;
         svely = 0;
         angvel = torque = Number(kinangvel = Number(pre_rot = Number(rot = 0)));
      ...
      {
         // method body index: 4269 method index: 4626
         ...
         _loc2_ = velx * velx + vely * vely > 0.2 ? false : (_loc3_ = 0,_loc4_ = 0,_loc3_ = posx - pre_posx,_loc4_ = posy - pre_posy,_loc3_ * _loc3_ + _loc4_ * _loc4_ > 0.05 * param1 * param1 ? false : (_loc3_ = 0,_loc4_ = 0,_loc3_ = aabb.maxx - aabb.minx,_loc4_ = aabb.maxy - aabb.miny,_loc5_ = _loc3_ * _loc3_ + _loc4_ * _loc4_,4 * angvel * angvel * _loc5_ > 0.4 ? false : (_loc6_ = rot - pre_rot,_loc6_ * _loc6_ * _loc5_ > 0.4 * param1 * param1 ? false : true)));
         if(!_loc2_)
         {
            component.waket = space.stamp;
         }
         return component.waket + 60 < space.stamp;
      }
      
      public function addedToSpace() : void
      {
         // method body index: 4270 method index: 4627
      ...
      {
         // method body index: 4271 method index: 4628
         var _loc1_:* = null as ZNPNode_ZPP_Shape;
         var _loc2_:* = null as ZPP_Shape;
         var _loc3_:* = null as ZPP_Circle;
         var _loc4_:* = null as ZPP_Polygon;
