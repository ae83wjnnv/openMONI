package zpp_nape.phys
{
   ...
   public class ZPP_Interactor
   {
      ...
      {
         // method body index: 4010 method index: 4313
      ...
      {
         // method body index: 3992 method index: 4333
      ...
      {
         // method body index: 3993 method index: 4334
         ...
         if(_loc6_.nonemptyintersection(_loc7_,_loc6_.includes) && !_loc6_.nonemptyintersection(_loc7_,_loc6_.excludes))
         {
            §§pop();
            _loc6_ = param2.options2;
            _loc7_ = _loc5_.cbTypes;
            §§push(_loc6_.nonemptyintersection(_loc7_,_loc6_.includes) && !_loc6_.nonemptyintersection(_loc7_,_loc6_.excludes));
         }
         if(§§pop())
         {
            param3.int1 = _loc4_;
      ...
      {
         // method body index: 3995 method index: 4315
      ...
      {
         // method body index: 3996 method index: 4316
      ...
      {
         // method body index: 3997 method index: 4317
      ...
      {
         // method body index: 3998 method index: 4318
      ...
      {
         // method body index: 3999 method index: 4319
      ...
      {
         // method body index: 4000 method index: 4322
         return icompound != null;
      }
      
      public function isBody() : Boolean
      {
         // method body index: 4001 method index: 4323
         return ibody != null;
      }
      
      public function insert_cbtype(param1:ZPP_CbType) : void
      {
         // method body index: 4002 method index: 4324
      ...
      {
         // method body index: 4003 method index: 4325
      ...
      {
         // method body index: 4004 method index: 4326
         immutable_midstep("Interactor::cbTypes");
      }
      
      public function dealloc_cbSet() : void
      {
         // method body index: 4005 method index: 4328
         var _loc2_:int = 0;
         ...
         if(cbSet != null)
         {
            ...
            var _temp_1:* = cbSet;
            if((_temp_1.count = _temp_1.count - 1) == 0)
            {
      ...
      {
         // method body index: 4006 method index: 4329
      ...
      {
         // method body index: 4007 method index: 4330
         var _loc1_:ZPP_Space = ishape != null ? (ishape.body == null ? null : ishape.body.space) : (ibody != null ? ibody.space : icompound.space);
      ...
      {
         // method body index: 4008 method index: 4331
         var _loc1_:int = 0;
      ...
      {
         // method body index: 4009 method index: 4332
