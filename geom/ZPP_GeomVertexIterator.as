package zpp_nape.geom
{
   ...
   public class ZPP_GeomVertexIterator
   {
      ...
      // method body index: 2959 method index: 3060
      public static var zpp_pool:ZPP_GeomVertexIterator = // method body index: 2961 method index: 3064
      null;
      
      public static var §internal§:Boolean = // method body index: 2961 method index: 3064
      false;
      ...
      {
         // method body index: 2960 method index: 3059
      ...
      {
         // method body index: 2958 method index: 3063
