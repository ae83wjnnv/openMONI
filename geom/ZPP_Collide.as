package zpp_nape.geom
{
   ...
   public class ZPP_Collide
   {
      ...
      // method body index: 4562 method index: 4924
      public static var flowpoly:ZNPList_ZPP_Vec2 = // method body index: 4564 method index: 4934
      new ZNPList_ZPP_Vec2();
      
      public static var flowsegs:ZNPList_ZPP_Vec2 = // method body index: 4564 method index: 4934
      new ZNPList_ZPP_Vec2();
      
      public function ZPP_Collide()
      {
         // method body index: 4563 method index: 4923
      }
      
      public static function circleContains(param1:ZPP_Circle, param2:ZPP_Vec2) : Boolean
      {
         // method body index: 4553 method index: 4925
         var _loc3_:Number = 0;
         var _loc4_:Number = 0;
      ...
      {
         // method body index: 4554 method index: 4926
      ...
      {
         // method body index: 4555 method index: 4927
      ...
      {
         // method body index: 4556 method index: 4928
      ...
      {
         // method body index: 4557 method index: 4929
      ...
      {
         // method body index: 4558 method index: 4930
            ...
            if(_loc5_)
            {
               ...
               if(_loc13_ <= _loc43_.y * _loc9_.gnormx - _loc43_.x * _loc9_.gnormy)
               {
                  ...
                  else
                  {
                     ...
                     _loc25_ = _loc24_ < 1e-8 ? 1e+100 : 1 / _loc24_;
         ...
         else
         {
            ...
            _loc22_ = _loc21_ < 1e-8 ? 1e+100 : 1 / _loc21_;
      ...
      {
         // method body index: 4559 method index: 4931
      ...
      {
         // method body index: 4560 method index: 4932
         var _loc3_:Boolean = false;
      ...
      {
         // method body index: 4561 method index: 4933
         ...
         if(param2.type == ZPP_Flags.id_ShapeType_POLYGON)
         {
            if(param1.type == ZPP_Flags.id_ShapeType_POLYGON)
            {
               ...
               while(_loc8_ != null)
               {
                  ...
                  while(_loc12_ != null)
                  {
                     ...
                     if(_loc14_ >= _loc9_.gprojection + 1e-8)
                     {
                        _loc5_[_loc11_] = true;
                        _loc7_ = false;
                     }
                        ...
                        if(_loc15_.zip_localCOM)
                        {
                           ...
                           if(_loc15_.type == ZPP_Flags.id_ShapeType_POLYGON)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc16_.localCOMy = 0;
                                 _loc10_ = 0;
                                 _loc13_ = _loc16_.lverts.next;
                                 _loc17_ = _loc13_.next;
                                 _loc12_ = _loc17_.next;
                                 while(_loc12_ != null)
                                 {
                                    _loc18_ = _loc12_;
                                 ...
                                 _loc18_ = _loc12_ = _loc16_.lverts.next;
                                 _loc10_ += _loc17_.x * (_loc18_.y - _loc13_.y);
                                 _loc14_ = _loc18_.y * _loc17_.x - _loc18_.x * _loc17_.y;
                                 _loc16_.localCOMx += (_loc17_.x + _loc18_.x) * _loc14_;
                                 _loc16_.localCOMy += (_loc17_.y + _loc18_.y) * _loc14_;
               ...
               else if(_loc6_)
               {
                  ...
                  else if(_loc6_)
                  {
                     ...
                     {
                        _loc26_ = true;
                        _loc19_ = _loc18_ = param1.polygon.gverts.next;
                        ...
                        while(_loc27_ != null)
                        {
                           ...
                           _loc10_ = 2;
                           _loc29_ = true;
                           _loc31_ = _loc30_ = param2.polygon.gverts.next;
                           ...
                           while(_loc32_ != null)
                           {
                              ...
                              if(_loc40_ * _loc40_ > 1e-8 ? (_loc40_ = 1 / _loc40_,_loc41_ = (_loc39_ * _loc34_ - _loc38_ * _loc35_) * _loc40_,_loc41_ > 1e-8 && _loc41_ < 0.99999999 ? (_loc42_ = (_loc37_ * _loc34_ - _loc36_ * _loc35_) * _loc40_,_loc42_ > 1e-8 && _loc42_ < 0.99999999 ? (_loc14_ = _loc41_,true) : false) : false) : false)
                              {
                                 if(_loc14_ < _loc10_)
                                 {
                                    _loc10_ = _loc14_;
                           ...
                           if(_loc29_)
                           {
                              do
                              {
                                 _loc33_ = _loc32_ = param2.polygon.gverts.next;
                                 _loc14_ = 0;
                                 _loc34_ = 0;
                                 _loc35_ = 0;
                                 _loc34_ = _loc19_.x - _loc31_.x;
                        ...
                        if(_loc26_)
                        {
                           do
                           {
                              _loc28_ = _loc27_ = param1.polygon.gverts.next;
                              _loc10_ = 2;
                              _loc29_ = true;
                              _loc31_ = _loc30_ = param2.polygon.gverts.next;
                              _loc32_ = _loc30_.next;
                     ...
                     while(true)
                     {
                        if(_loc21_)
                        {
                           ...
                           {
                              _loc18_ = _loc13_;
                              if(_loc12_ != null && _loc10_ * _loc10_ + _loc14_ * _loc14_ < 1e-8)
                              {
                                 break;
                              }
                           ...
                           else
                           {
                              ...
                              if(_loc12_ != null && _loc35_ * _loc35_ + _loc36_ * _loc36_ < 1e-8)
                              {
                                 break;
                              }
            ...
            else
            {
               ...
               while(_loc8_ != null)
               {
                  ...
                  if(_loc14_ + param1.circle.radius > _loc45_.gprojection + 1e-8)
                  {
                     _loc6_ = false;
                     _loc4_[_loc11_] = true;
                  }
               ...
               if(_loc7_)
               {
                  ...
                  else
                  {
                     ...
                     _loc37_ = _loc35_ * _loc35_ + _loc36_ * _loc36_;
                     _loc14_ = param1.circle.worldCOMy * _loc9_.gnormx - param1.circle.worldCOMx * _loc9_.gnormy;
                     if(_loc14_ <= _loc17_.y * _loc9_.gnormx - _loc17_.x * _loc9_.gnormy ? (_loc34_ = param1.circle.radius,_loc35_ = 0,_loc36_ = 0,_loc35_ = _loc17_.x - param1.circle.worldCOMx,_loc36_ = _loc17_.y - param1.circle.worldCOMy,_loc37_ <= _loc34_ * _loc34_) : (_loc14_ >= _loc18_.y * _loc9_.gnormx - _loc18_.x * _loc9_.gnormy ? (_loc34_ = param1.circle.radius,_loc35_ = 0,_loc36_ = 0,_loc35_ = _loc18_.x - param1.circle.worldCOMx,_loc36_ = _loc18_.y - param1.circle.worldCOMy,(_loc37_ = _loc35_ * _loc35_ + _loc36_ * _loc36_) <= _loc34_ * _loc34_) : true))
                     {
                        _loc5_ = [];
                        _loc22_ = 0;
                        _loc21_ = true;
                                 ...
                                 if(_loc15_.zip_localCOM)
                                 {
                                    ...
                                    if(_loc15_.type == ZPP_Flags.id_ShapeType_POLYGON)
                                    {
                                       ...
                                       else
                                       {
                                          ...
                                          _loc16_.localCOMy = 0;
                                          _loc34_ = 0;
                                          _loc28_ = _loc16_.lverts.next;
                                          _loc30_ = _loc28_.next;
                                          _loc27_ = _loc30_.next;
                                          while(_loc27_ != null)
                                          {
                                             _loc31_ = _loc27_;
                                          ...
                                          _loc31_ = _loc27_ = _loc16_.lverts.next;
                                          _loc34_ += _loc30_.x * (_loc31_.y - _loc28_.y);
                                          _loc35_ = _loc31_.y * _loc30_.x - _loc31_.x * _loc30_.y;
                                          _loc16_.localCOMx += (_loc30_.x + _loc31_.x) * _loc35_;
                                          _loc16_.localCOMy += (_loc30_.y + _loc31_.y) * _loc35_;
                        ...
                        else
                        {
                           ...
                           while(_loc24_ != 0)
                           {
                              if(_loc24_ == 1)
                              {
                                 ...
                                 if(_loc5_[_loc23_])
                                 {
                                    ...
                                    if(_loc34_ * _loc34_ + _loc35_ * _loc35_ < 1e-8)
                                    {
                                       break;
                                    }
                                 ...
                                 else
                                 {
                                    ...
                                    _loc34_ = _loc46_ < 1e-8 ? (-_loc40_ + _loc42_) * _loc39_ : _loc46_;
                                    _loc35_ = 0;
                                    _loc36_ = 0;
                                    _loc37_ = _loc34_;
                                    ...
                                    if(_loc37_ * _loc37_ + _loc38_ * _loc38_ < 1e-8)
                                    {
                                       break;
                                    }
                                    §§push(ZPP_Collide.flowpoly);
                              ...
                              else if(_loc24_ == 2)
                              {
                                 ...
                                 do
                                 {
                                    ...
                                    if(_loc4_[_loc23_])
                                    {
                                       ...
                                       _loc26_ = §§pop();
                                       if(_loc34_ < 0.99999999 && _loc35_ > 1e-8)
                                       {
                                          _loc36_ = 0;
                                          _loc37_ = 0;
                                          _loc38_ = _loc34_;
                                          ...
                                          if(_loc27_ != null && _loc38_ * _loc38_ + _loc39_ * _loc39_ < 1e-8)
                                          {
                                             _loc24_ = 0;
                                             _loc32_ = _loc31_;
                                             break;
                           ...
                           else
                           {
                              ...
                              while(ZPP_Collide.flowsegs.head != null)
                              {
                                 ...
                                 si32(1597463007 - (li32(0) >> 1),0);
                                 _loc46_ = lf32(0);
                                 _loc46_ = _loc42_ = _loc46_ * (1.5 - 0.5 * _loc41_ * _loc46_ * _loc46_);
                                 _loc39_ *= _loc46_;
                                 _loc40_ *= _loc46_;
                                 _loc41_ = _loc39_;
                                 _loc39_ = -_loc40_;
