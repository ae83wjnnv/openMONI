package zpp_nape.geom
{
   ...
   public class ZPP_Ray
   {
      ...
      // method body index: 6389 method index: 6933
      public static var §internal§:Boolean = // method body index: 6401 method index: 6945
      false;
      ...
      {
         // method body index: 6400 method index: 6932
      ...
      {
         // method body index: 6390 method index: 6934
         ...
         if(zip_dir)
         {
            ...
            normalx = -diry;
            normaly = dirx;
            §§push(§§findproperty(absnormalx));
            _loc1_ = normalx;
            §§pop().absnormalx = _loc1_ < 0 ? -_loc1_ : _loc1_;
            §§push(§§findproperty(absnormaly));
            _loc1_ = normaly;
            §§pop().absnormaly = _loc1_ < 0 ? -_loc1_ : _loc1_;
         }
      }
      
      public function rayAABB() : ZPP_AABB
      {
         // method body index: 6391 method index: 6935
      ...
      {
         // method body index: 6392 method index: 6936
         ...
         _loc9_ = true;
         var _loc11_:ZPP_Vec2 = param1.gverts.next;
         var _loc12_:ZPP_Vec2 = _loc11_.next;
         while(_loc12_ != null)
         {
            _loc13_ = _loc12_;
            _loc14_ = _loc8_.elt;
            if(param2 || _loc14_.gnormx * dirx + _loc14_.gnormy * diry < 0)
            {
               ...
               if(_loc19_ * _loc19_ > 1e-8)
               {
                  ...
                  if(_loc20_ > 0 && _loc20_ <= maxdist && (_loc20_ < _loc4_ || _loc20_ > _loc5_))
                  {
                     ...
                     if(_loc21_ > -1e-8 && _loc21_ < 1.00000001)
                     {
                        if(_loc20_ < _loc4_)
                        {
                           _loc4_ = _loc20_;
         ...
         if(_loc9_)
         {
            do
            {
               _loc13_ = _loc12_ = param1.gverts.next;
               _loc14_ = _loc8_.elt;
               if(param2 || _loc14_.gnormx * dirx + _loc14_.gnormy * diry < 0)
               {
                  _loc15_ = 0;
      ...
      {
         // method body index: 6393 method index: 6937
         ...
         _loc7_ = true;
         var _loc9_:ZPP_Vec2 = param1.gverts.next;
         var _loc10_:ZPP_Vec2 = _loc9_.next;
         while(_loc10_ != null)
         {
            _loc11_ = _loc10_;
            _loc12_ = _loc6_.elt;
            if(param2 || _loc12_.gnormx * dirx + _loc12_.gnormy * diry < 0)
            {
               ...
               if(_loc17_ * _loc17_ > 1e-8)
               {
                  ...
                  if(_loc18_ > 0 && _loc18_ < _loc4_ && _loc18_ <= maxdist)
                  {
                     ...
                     if(_loc19_ > -1e-8 && _loc19_ < 1.00000001)
                     {
                        _loc4_ = _loc18_;
                        _loc5_ = _loc6_.elt;
                     }
         ...
         if(_loc7_)
         {
            do
            {
               _loc11_ = _loc10_ = param1.gverts.next;
               _loc12_ = _loc6_.elt;
               if(param2 || _loc12_.gnormx * dirx + _loc12_.gnormy * diry < 0)
               {
                  _loc13_ = 0;
      ...
      {
         // method body index: 6394 method index: 6938
         originx = param1.x;
         originy = param1.y;
      }
      ...
      {
         // method body index: 6395 method index: 6940
         dirx = param1.x;
         diry = param1.y;
         zip_dir = true;
      }
      ...
      {
         // method body index: 6396 method index: 6941
         ...
         if(_loc16_ == 0)
         {
            ...
            if((!param2 || _loc15_ > 0) && _loc17_ > 0 && _loc17_ <= maxdist)
            {
               ...
               _loc22_ = _loc21_ = 1 / Math.sqrt(_loc20_);
               _loc18_ *= _loc22_;
               _loc19_ *= _loc22_;
               if(_loc15_ <= 0)
               {
         ...
         else
         {
            ...
            if(_loc17_ > 0 && _loc17_ <= maxdist)
            {
               ...
               _loc32_ = _loc22_ = 1 / Math.sqrt(_loc21_);
               _loc19_ *= _loc32_;
               _loc20_ *= _loc32_;
               §§push(ZPP_ConvexRayResult);
               _loc24_ = false;
      ...
      {
         // method body index: 6397 method index: 6942
         var _loc4_:* = null as ZPP_Polygon;
         var _loc5_:Number = NaN;
         var _loc6_:* = null as ZPP_Vec2;
         var _loc7_:* = null as ZPP_Vec2;
         ...
         if(_loc17_ > 0)
         {
            if(_loc17_ < param3 && _loc17_ <= maxdist)
            {
               ...
               _loc20_ -= param1.worldCOMy * _loc21_;
               _loc21_ = _loc19_ * _loc19_ + _loc20_ * _loc20_;
               _loc26_ = _loc22_ = 1 / Math.sqrt(_loc21_);
               _loc19_ *= _loc26_;
               _loc20_ *= _loc26_;
               §§push(ZPP_ConvexRayResult);
               _loc23_ = false;
      ...
      {
         // method body index: 6398 method index: 6943
      ...
      {
         // method body index: 6399 method index: 6944
