package zpp_nape.geom
{
   ...
   public class ZPP_Mat23
   {
      ...
      // method body index: 2923 method index: 2999
      public static var zpp_pool:ZPP_Mat23 = // method body index: 2927 method index: 3008
      null;
      ...
      {
         // method body index: 2926 method index: 2998
      ...
      {
         // method body index: 2921 method index: 3006
      ...
      {
         // method body index: 2922 method index: 3007
      ...
      {
         // method body index: 2924 method index: 3000
         var _loc1_:* = null as ZPP_Mat23;
         if(outer == null)
         {
            outer = new Mat23();
      ...
      {
         // method body index: 2925 method index: 3001
         tx = param5;
         ty = param6;
         a = param1;
         b = param2;
