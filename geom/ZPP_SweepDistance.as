package zpp_nape.geom
{
   ...
   public class ZPP_SweepDistance
   {
      ...
      {
         // method body index: 6265 method index: 6777
      }
      ...
      {
         // method body index: 6260 method index: 6779
         ...
         if(!param5 && !param1.kinematic && _loc10_ * _loc10_ + _loc11_ * _loc11_ < 300 && _loc14_ < 0.6)
         {
            param1.toi = -1;
            param1.failed = true;
            return;
         ...
         while(true)
         {
            ...
            if(_loc34_.type == ZPP_Flags.id_ShapeType_CIRCLE && _loc35_.type == ZPP_Flags.id_ShapeType_CIRCLE)
            {
               ...
               var _temp_13:*;
               _loc25_ = _loc26_ == 0 ? 0 : (_temp_13 = 1,sf32(_loc26_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_13 / (_loc38_ * (1.5 - 0.5 * _loc26_ * _loc38_ * _loc38_)));
               var _temp_13:*;
               ...
               if(_loc34_.type == ZPP_Flags.id_ShapeType_POLYGON && _loc35_.type == ZPP_Flags.id_ShapeType_CIRCLE)
               {
                  ...
                  if(_loc22_ < _loc21_)
                  {
                     ...
                     if(_loc23_ <= _loc30_.y * _loc33_.gnormx - _loc30_.x * _loc33_.gnormy)
                     {
                        ...
                        var _temp_21:*;
                        _loc26_ = _loc38_ == 0 ? 0 : (_temp_21 = 1,sf32(_loc38_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_21 / (_loc42_ * (1.5 - 0.5 * _loc38_ * _loc42_ * _loc42_)));
                        var _temp_21:*;
                     ...
                     else if(_loc23_ >= _loc31_.y * _loc33_.gnormx - _loc31_.x * _loc33_.gnormy)
                     {
                        ...
                        _loc38_ = _loc24_ * _loc24_ + _loc25_ * _loc25_;
                        var _temp_26:*;
                        _loc26_ = _loc38_ == 0 ? 0 : (_temp_26 = 1,sf32(_loc38_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_26 / (_loc42_ * (1.5 - 0.5 * _loc38_ * _loc42_ * _loc42_)));
                        var _temp_26:*;
                        _loc22_ = _loc26_ - _loc36_.radius;
                        var _temp_26:*;
                        if(_loc22_ < _loc21_)
      ...
      {
         // method body index: 6261 method index: 6780
         ...
         while(true)
         {
            ...
            if(_loc32_.type == ZPP_Flags.id_ShapeType_CIRCLE && _loc33_.type == ZPP_Flags.id_ShapeType_CIRCLE)
            {
               ...
               var _temp_8:*;
               _loc23_ = _loc24_ == 0 ? 0 : (_temp_8 = 1,sf32(_loc24_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_8 / (_loc36_ * (1.5 - 0.5 * _loc24_ * _loc36_ * _loc36_)));
               var _temp_8:*;
               ...
               if(_loc32_.type == ZPP_Flags.id_ShapeType_POLYGON && _loc33_.type == ZPP_Flags.id_ShapeType_CIRCLE)
               {
                  ...
                  if(_loc20_ < _loc19_)
                  {
                     ...
                     if(_loc21_ <= _loc28_.y * _loc31_.gnormx - _loc28_.x * _loc31_.gnormy)
                     {
                        ...
                        var _temp_16:*;
                        _loc24_ = _loc36_ == 0 ? 0 : (_temp_16 = 1,sf32(_loc36_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_16 / (_loc40_ * (1.5 - 0.5 * _loc36_ * _loc40_ * _loc40_)));
                        var _temp_16:*;
                     ...
                     else if(_loc21_ >= _loc29_.y * _loc31_.gnormx - _loc29_.x * _loc31_.gnormy)
                     {
                        ...
                        _loc36_ = _loc22_ * _loc22_ + _loc23_ * _loc23_;
                        var _temp_21:*;
                        _loc24_ = _loc36_ == 0 ? 0 : (_temp_21 = 1,sf32(_loc36_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_21 / (_loc40_ * (1.5 - 0.5 * _loc36_ * _loc40_ * _loc40_)));
                        var _temp_21:*;
                        _loc20_ = _loc24_ - _loc34_.radius;
                        var _temp_21:*;
                        if(_loc20_ < _loc19_)
      ...
      {
         // method body index: 6262 method index: 6781
         ...
         while(_loc9_ != null)
         {
            ...
            while(_loc11_ != null)
            {
               ...
               if(_loc14_.type == ZPP_Flags.id_ShapeType_CIRCLE && _loc15_.type == ZPP_Flags.id_ShapeType_CIRCLE)
               {
                  ...
                  _loc24_ = _loc21_ * _loc21_ + _loc22_ * _loc22_;
                  var _temp_4:*;
                  _loc23_ = _loc24_ == 0 ? 0 : (_temp_4 = 1,sf32(_loc24_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_4 / (_loc25_ * (1.5 - 0.5 * _loc24_ * _loc25_ * _loc25_)));
                  var _temp_4:*;
                  ...
                  if(_loc14_.type == ZPP_Flags.id_ShapeType_POLYGON && _loc15_.type == ZPP_Flags.id_ShapeType_CIRCLE)
                  {
                     ...
                     if(_loc20_ < _loc8_)
                     {
                        ...
                        if(_loc21_ <= _loc28_.y * _loc30_.gnormx - _loc28_.x * _loc30_.gnormy)
                        {
                           ...
                           var _temp_12:*;
                           _loc24_ = _loc25_ == 0 ? 0 : (_temp_12 = 1,sf32(_loc25_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_12 / (_loc34_ * (1.5 - 0.5 * _loc25_ * _loc34_ * _loc34_)));
                           var _temp_12:*;
                        ...
                        else if(_loc21_ >= _loc33_.y * _loc30_.gnormx - _loc33_.x * _loc30_.gnormy)
                        {
                           ...
                           _loc25_ = _loc22_ * _loc22_ + _loc23_ * _loc23_;
                           var _temp_17:*;
                           _loc24_ = _loc25_ == 0 ? 0 : (_temp_17 = 1,sf32(_loc25_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_17 / (_loc34_ * (1.5 - 0.5 * _loc25_ * _loc34_ * _loc34_)));
                           var _temp_17:*;
                           _loc20_ = _loc24_ - _loc18_.radius;
                           var _temp_17:*;
                           if(_loc20_ < _loc8_)
      ...
      {
         // method body index: 6263 method index: 6782
         ...
         if(param1.type == ZPP_Flags.id_ShapeType_CIRCLE && param2.type == ZPP_Flags.id_ShapeType_CIRCLE)
         {
            ...
            var _temp_3:*;
            _loc12_ = _loc13_ == 0 ? 0 : (_temp_3 = 1,sf32(_loc13_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_3 / (_loc14_ * (1.5 - 0.5 * _loc13_ * _loc14_ * _loc14_)));
            var _temp_3:*;
         ...
         if(param1.type == ZPP_Flags.id_ShapeType_POLYGON && param2.type == ZPP_Flags.id_ShapeType_CIRCLE)
         {
            ...
            if(_loc9_ < param6)
            {
               ...
               if(_loc10_ <= _loc17_.y * _loc19_.gnormx - _loc17_.x * _loc19_.gnormy)
               {
                  ...
                  var _temp_11:*;
                  _loc13_ = _loc14_ == 0 ? 0 : (_temp_11 = 1,sf32(_loc14_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_11 / (_loc23_ * (1.5 - 0.5 * _loc14_ * _loc23_ * _loc23_)));
                  var _temp_11:*;
               ...
               else if(_loc10_ >= _loc22_.y * _loc19_.gnormx - _loc22_.x * _loc19_.gnormy)
               {
                  ...
                  _loc14_ = _loc11_ * _loc11_ + _loc12_ * _loc12_;
                  var _temp_16:*;
                  _loc13_ = _loc14_ == 0 ? 0 : (_temp_16 = 1,sf32(_loc14_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_16 / (_loc23_ * (1.5 - 0.5 * _loc14_ * _loc23_ * _loc23_)));
                  var _temp_16:*;
                  _loc9_ = _loc13_ - _loc7_.radius;
                  var _temp_16:*;
                  if(_loc9_ < param6)
