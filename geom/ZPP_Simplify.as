package zpp_nape.geom
{
   ...
   public class ZPP_Simplify
   {
      ...
      // method body index: 5784 method index: 6244
      public static var stack:ZNPList_ZPP_SimplifyP = // method body index: 5786 method index: 6249
      null;
      
      public function ZPP_Simplify()
      {
         // method body index: 5785 method index: 6243
      }
      
      public static function lessval(param1:ZPP_SimplifyV, param2:ZPP_SimplifyV) : Number
      {
         // method body index: 5780 method index: 6245
         return param1.x - param2.x + (param1.y - param2.y);
      }
      
      public static function less(param1:ZPP_SimplifyV, param2:ZPP_SimplifyV) : Boolean
      {
         // method body index: 5781 method index: 6246
      ...
      {
         // method body index: 5782 method index: 6247
      ...
      {
         // method body index: 5783 method index: 6248
         ...
         while(_loc8_ = _loc8_.next, _loc8_ != param1);
         ...
         while(_loc3_ != null)
         {
            ...
            _loc3_ = null;
            _loc9_ = _loc3_;
            _loc3_ = _loc3_ != null && _loc3_.prev == _loc3_ ? (_loc3_.next = _loc3_.prev = null,_loc9_.next = ZPP_SimplifyV.zpp_pool,ZPP_SimplifyV.zpp_pool = _loc9_,_loc3_) : (_loc9_ = _loc3_.next,_loc3_.prev.next = _loc3_.next,_loc3_.next.prev = _loc3_.prev,_loc3_.next = _loc3_.prev = null,_loc10_.next = ZPP_SimplifyV.zpp_pool,ZPP_SimplifyV.zpp_pool = _loc10_,_loc3_ = null,_loc9_);
         }
         return _loc18_;
      }
   }
