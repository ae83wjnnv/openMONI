package zpp_nape.geom
{
   ...
   public class ZPP_PartitionedPoly
   {
      ...
      // method body index: 3060 method index: 3173
      public static var zpp_pool:ZPP_PartitionedPoly = // method body index: 3072 method index: 3186
      null;
      ...
      {
         // method body index: 3071 method index: 3172
      ...
      {
         // method body index: 3058 method index: 3184
      ...
      {
         // method body index: 3059 method index: 3185
      ...
      {
         // method body index: 3061 method index: 3174
         ...
         do
         {
            ...
            while(_loc2_ || _loc1_ != vertices)
            {
               ...
               else
               {
                  ...
                  _loc1_ = null;
                  _loc4_ = _loc1_;
                  _loc1_ = _loc1_ != null && _loc1_.prev == _loc1_ ? (_loc1_.next = _loc1_.prev = null,_loc4_.helper = null,null,_loc4_.next = ZPP_PartitionVertex.zpp_pool,ZPP_PartitionVertex.zpp_pool = _loc4_,_loc1_) : (_loc4_ = _loc1_.next,_loc1_.prev.next = _loc1_.next,_loc1_.next.prev = _loc1_.prev,_loc1_.next = _loc1_.prev = null,_loc11_.helper = null,null,_loc11_.next = ZPP_PartitionVertex.zpp_pool,ZPP_PartitionVertex.zpp_pool = _loc11_,_loc1_ = null,_loc4_);
                  _loc5_ = true;
                  if(_loc1_ == null)
                  {
                     _loc5_ = false;
      ...
      {
         // method body index: 3062 method index: 3175
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc9_ = _loc9_.next, _loc9_ != _loc6_);
         }
         if(_loc8_ * 0.5 != 0)
         {
            param2.add(_loc3_);
      ...
      {
         // method body index: 3063 method index: 3176
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc12_ = _loc12_.next, _loc12_ != _loc6_);
         }
         ...
         if(_loc10_ * _loc10_ >= 1e-16)
         {
            ...
            while(_loc14_ || _loc5_ != _loc3_)
            {
               ...
               if(_loc11_ * _loc11_ + _loc15_ * _loc15_ < 1e-16)
               {
                  if(_loc5_ == _loc3_)
                  {
                     _loc3_ = _loc5_.next;
      ...
      {
         // method body index: 3064 method index: 3177
         var _loc6_:* = null as ZPP_GeomVert;
      ...
      {
         // method body index: 3067 method index: 3180
         var _loc2_:* = null as ZPP_PartitionVertex;
         var _loc3_:* = null as ZPP_PartitionVertex;
         var _loc4_:* = null as ZPP_PartitionVertex;
         var _loc5_:* = null as ZPP_PartitionVertex;
      ...
      {
         // method body index: 3068 method index: 3181
         var _loc3_:Number = 0;
         var _loc4_:Number = 0;
         _loc3_ = param1.x - param2.x;
         _loc4_ = param1.y - param2.y;
         return _loc3_ * _loc3_ + _loc4_ * _loc4_ < 1e-16;
      }
      
      public function alloc() : void
      {
         // method body index: 3069 method index: 3182
      }
      
      public function add_diagonal(param1:ZPP_PartitionVertex, param2:ZPP_PartitionVertex) : void
      {
         // method body index: 3070 method index: 3183
