package zpp_nape.geom
{
   ...
   public class ZPP_Vec2
   {
      ...
      // method body index: 3488 method index: 3744
      public static var zpp_pool:ZPP_Vec2 = // method body index: 3515 method index: 3784
      null;
      ...
      {
         // method body index: 3514 method index: 3743
      ...
      {
         // method body index: 3487 method index: 3783
      ...
      {
         // method body index: 3489 method index: 3747
      ...
      {
         // method body index: 3490 method index: 3748
         return "{ x: " + x + " y: " + y + " }";
      }
      
      public function splice(param1:ZPP_Vec2, param2:int) : ZPP_Vec2
      {
         // method body index: 3491 method index: 3749
      ...
      {
         // method body index: 3492 method index: 3750
         return length;
      }
      
      public function reverse() : void
      {
         // method body index: 3493 method index: 3752
      ...
      {
         // method body index: 3494 method index: 3753
      ...
      {
         // method body index: 3495 method index: 3754
         var _loc1_:ZPP_Vec2 = next;
         pop();
         return _loc1_;
      }
      ...
      {
         // method body index: 3496 method index: 3755
         var _loc1_:ZPP_Vec2 = next;
         next = _loc1_.next;
         _loc1_._inuse = false;
         if(next == null)
      ...
      {
         // method body index: 3497 method index: 3756
      ...
      {
         // method body index: 3498 method index: 3758
         param2._inuse = true;
      ...
      {
         // method body index: 3499 method index: 3761
         var _loc1_:ZPP_Vec2 = next;
         pop();
         return _loc1_;
      }
      ...
      {
         // method body index: 3500 method index: 3762
         var _loc1_:ZPP_Vec2 = next;
         next = _loc1_.next;
         _loc1_._inuse = false;
         if(next == null)
      ...
      {
         // method body index: 3501 method index: 3763
         param2._inuse = true;
         var _loc3_:ZPP_Vec2 = param2;
         if(param1 == null)
         {
      ...
      {
         // method body index: 3502 method index: 3764
         var _loc4_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 3503 method index: 3765
      ...
      {
         // method body index: 3504 method index: 3766
      }
      
      public function inlined_add(param1:ZPP_Vec2) : ZPP_Vec2
      {
         // method body index: 3505 method index: 3767
         param1._inuse = true;
      ...
      {
         // method body index: 3506 method index: 3769
         var _loc4_:* = null as ZPP_Vec2;
         var _loc2_:Boolean = false;
         var _loc3_:ZPP_Vec2 = next;
         while(_loc3_ != null)
      ...
      {
         // method body index: 3507 method index: 3772
         var _loc2_:* = null as ZPP_Vec2;
         var _loc3_:* = null as ZPP_Vec2;
         if(param1 == null)
         {
      ...
      {
         // method body index: 3508 method index: 3776
      }
      
      public function begin() : ZPP_Vec2
      {
         // method body index: 3509 method index: 3777
         return next;
      }
      
      public function back() : ZPP_Vec2
      {
         // method body index: 3510 method index: 3778
         var _loc1_:ZPP_Vec2 = next;
      ...
      {
         // method body index: 3511 method index: 3779
      ...
      {
         // method body index: 3512 method index: 3781
         var _loc3_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 3513 method index: 3782
         param1._inuse = true;
         var _loc2_:ZPP_Vec2 = param1;
         _loc2_.next = next;
         next = _loc2_;
