package zpp_nape.geom
{
   ...
   public class ZPP_Triangular
   {
      ...
      // method body index: 5824 method index: 6283
      public static var queue:ZNPList_ZPP_PartitionVertex = // method body index: 5826 method index: 6289
      null;
      
      public static var stack:ZNPList_ZPP_PartitionVertex = // method body index: 5826 method index: 6289
      null;
      
      public static var edgeSet:ZPP_Set_ZPP_PartitionPair = // method body index: 5826 method index: 6289
      null;
      
      public function ZPP_Triangular()
      {
         // method body index: 5825 method index: 6282
      }
      
      public static function lt(param1:ZPP_PartitionVertex, param2:ZPP_PartitionVertex) : Boolean
      {
         // method body index: 5819 method index: 6284
      ...
      {
         // method body index: 5820 method index: 6285
         var _loc4_:Number = 0;
         var _loc5_:Number = 0;
      ...
      {
         // method body index: 5821 method index: 6286
         var _loc5_:Number = 0;
         var _loc6_:Number = 0;
         var _loc7_:Number = 0;
         var _loc8_:Number = 0;
         ...
         if(_loc8_ * _loc5_ - _loc7_ * _loc6_ < 0)
         {
            §§pop();
            _loc5_ = param4.x - param3.x;
            _loc6_ = param4.y - param3.y;
            _loc7_ = param3.x - param2.x;
            _loc8_ = param3.y - param2.y;
            §§push(_loc8_ * _loc5_ - _loc7_ * _loc6_ >= 0);
         }
         if(!§§pop())
         {
            §§pop();
            _loc5_ = param1.x - param4.x;
            _loc6_ = param1.y - param4.y;
            _loc7_ = param4.x - param3.x;
         ...
         if(!§§pop())
         {
            ...
            _loc6_ = param2.y - param1.y;
            _loc7_ = param1.x - param4.x;
            _loc8_ = param1.y - param4.y;
            §§push(_loc8_ * _loc5_ - _loc7_ * _loc6_ >= 0);
         }
         if(§§pop())
         {
      ...
      {
         // method body index: 5822 method index: 6287
      ...
      {
         // method body index: 5823 method index: 6288
