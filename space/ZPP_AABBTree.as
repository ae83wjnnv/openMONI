package zpp_nape.space
{
   ...
   public class ZPP_AABBTree
   {
      ...
      // method body index: 6861 method index: 7470
      public static var tmpaabb:ZPP_AABB = // method body index: 6868 method index: 7477
      new ZPP_AABB();
      ...
      {
         // method body index: 6867 method index: 7469
      ...
      {
         // method body index: 6862 method index: 7471
         ...
         else
         {
            ...
            if(_loc3_ != null)
            {
               ...
               while(_loc5_ != null)
               {
                  ...
                  else
                  {
                     ...
                     if(_loc10_ > 1)
                     {
                        ...
                        if(_loc11_.height > _loc12_.height)
                        {
                           ...
                           §§pop().height = §§pop() + (_loc15_ > _loc16_ ? _loc15_ : _loc16_);
                           §§push(_loc9_);
                           §§push(1);
                  ...
                  _loc15_ = _loc9_.height;
                  §§pop().height = §§pop() + (_loc10_ > _loc15_ ? _loc10_ : _loc15_);
      ...
      {
         // method body index: 6863 method index: 7472
         ...
         else
         {
            ...
            while(_loc3_.child1 != null)
            {
               ...
               _loc14_ = ((_loc7_ = ZPP_AABBTree.tmpaabb).maxx - _loc7_.minx + (_loc7_.maxy - _loc7_.miny)) * 2;
               _loc7_ = _loc4_.aabb;
               _loc7_ = ZPP_AABBTree.tmpaabb;
               _loc12_ = _loc4_.child1 == null ? (_loc7_.maxx - _loc7_.minx + (_loc7_.maxy - _loc7_.miny)) * 2 + _loc11_ : (_loc13_ = (_loc7_.maxx - _loc7_.minx + (_loc7_.maxy - _loc7_.miny)) * 2,_loc14_ - _loc13_ + _loc11_);
               _loc7_ = ZPP_AABBTree.tmpaabb;
               _loc8_ = _loc5_.aabb;
               _loc7_.minx = _loc2_.minx < _loc8_.minx ? _loc2_.minx : _loc8_.minx;
               _loc7_.miny = _loc2_.miny < _loc8_.miny ? _loc2_.miny : _loc8_.miny;
               _loc7_.maxx = _loc2_.maxx > _loc8_.maxx ? _loc2_.maxx : _loc8_.maxx;
               _loc7_.maxy = _loc2_.maxy > _loc8_.maxy ? _loc2_.maxy : _loc8_.maxy;
               _loc15_ = ((_loc7_ = ZPP_AABBTree.tmpaabb).maxx - _loc7_.minx + (_loc7_.maxy - _loc7_.miny)) * 2;
               _loc7_ = _loc5_.aabb;
               _loc7_ = ZPP_AABBTree.tmpaabb;
               _loc13_ = _loc5_.child1 == null ? (_loc7_.maxx - _loc7_.minx + (_loc7_.maxy - _loc7_.miny)) * 2 + _loc11_ : (_loc14_ = (_loc7_.maxx - _loc7_.minx + (_loc7_.maxy - _loc7_.miny)) * 2,_loc15_ - _loc14_ + _loc11_);
            ...
            while(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  if(_loc19_ > 1)
                  {
                     ...
                     if(_loc20_.height > _loc21_.height)
                     {
                        ...
                        §§pop().height = §§pop() + (_loc23_ > _loc24_ ? _loc23_ : _loc24_);
                        §§push(_loc18_);
                        §§push(1);
               ...
               _loc23_ = _loc18_.height;
               §§pop().height = §§pop() + (_loc19_ > _loc23_ ? _loc19_ : _loc23_);
               _loc7_ = _loc3_.aabb;
               _loc8_ = _loc17_.aabb;
      ...
      {
         // method body index: 6864 method index: 7473
         var _loc2_:* = null as ZPP_AABBNode;
         var _loc3_:* = null as ZPP_AABBNode;
         var _loc4_:* = null as ZPP_AABBNode;
         var _loc5_:* = null as ZPP_AABBNode;
      ...
      {
         // method body index: 6865 method index: 7474
         var _loc2_:* = null as ZPP_AABB;
         var _loc3_:* = null as ZPP_AABBNode;
         var _loc4_:* = null as ZPP_AABBNode;
         var _loc5_:* = null as ZPP_AABBNode;
      ...
      {
         // method body index: 6866 method index: 7475
         var _loc2_:* = null as ZPP_AABBNode;
         var _loc3_:* = null as ZPP_AABBNode;
