package zpp_nape.space
{
   ...
   public class ZPP_SweepPhase extends ZPP_Broadphase
   {
      ...
      {
         // method body index: 6232 method index: 6725
      ...
      {
         // method body index: 6217 method index: 6728
      ...
      {
         // method body index: 6218 method index: 6729
      ...
      {
         // method body index: 6219 method index: 6730
      ...
      {
         // method body index: 6220 method index: 6731
      ...
      {
         // method body index: 6221 method index: 6732
         var _loc9_:* = null as ZPP_Shape;
         var _loc10_:* = null as ZPP_InteractionFilter;
      ...
      {
         // method body index: 6222 method index: 6733
         ...
         if(param1.dirx == 0)
         {
            ...
            while(_loc7_ != null && _loc7_.aabb.minx <= _loc5_.minx)
            {
               ...
               {
                  §§pop();
                  §§push(param3 == null || (_loc9_.collisionMask & param3.collisionGroup) != 0 && (param3.collisionMask & _loc9_.collisionGroup) != 0);
               }
               if(§§pop())
               {
      ...
      {
         // method body index: 6223 method index: 6734
         var _loc7_:* = null as ZPP_SweepData;
         var _loc8_:* = null as ZPP_AABB;
         var _loc9_:* = null as ZPP_InteractionFilter;
         var _loc10_:Number = NaN;
         ...
         if(param1.dirx == 0)
         {
            ...
            while(_loc7_ != null && _loc7_.aabb.minx <= _loc4_.minx)
            {
               §§push(false);
               _loc8_ = _loc7_.aabb;
               if(_loc4_.miny <= _loc8_.maxy && _loc8_.miny <= _loc4_.maxy && _loc4_.minx <= _loc8_.maxx && _loc8_.minx <= _loc4_.maxx)
               {
                  §§pop();
                  §§push(param3 == null || (_loc9_.collisionMask & param3.collisionGroup) != 0 && (param3.collisionMask & _loc9_.collisionGroup) != 0);
               }
      ...
      {
         // method body index: 6224 method index: 6735
         while(list != null)
         {
      ...
      {
         // method body index: 6225 method index: 6736
         var _loc3_:* = null as ZPP_SweepData;
         var _loc4_:* = null as ZPP_SweepData;
      ...
      {
         // method body index: 6226 method index: 6737
         var _loc7_:* = null as ZPP_Vec2;
         var _loc10_:* = null as ZPP_Shape;
      ...
      {
         // method body index: 6227 method index: 6738
         var _loc8_:* = null as ZPP_AABB;
         var _loc9_:* = null as ZPP_Shape;
      ...
      {
         // method body index: 6228 method index: 6739
         var _loc10_:* = null as ZPP_AABB;
         var _loc11_:* = null as ZPP_Shape;
      ...
      {
         // method body index: 6229 method index: 6740
         var _loc9_:* = null as ZPP_Shape;
         var _loc10_:* = null as Body;
         var _loc11_:* = null as ZPP_AABB;
         var _loc12_:* = null as ZPP_InteractionFilter;
      ...
      {
         // method body index: 6230 method index: 6742
      ...
      {
         // method body index: 6231 method index: 6743
         var _loc2_:* = null as ZPP_SweepData;
