package starling.text
{
   ...
   internal class MiniBitmapFont
   {
      ...
      public static function get texture() : Texture
      {
         ...
         while(_loc4_ < _loc3_)
         {
            _loc2_.writeUnsignedInt(BITMAP_DATA[_loc4_]);
            _loc4_++;
         }
         _loc2_.uncompress();
         _loc1_.setPixels(new Rectangle(0,0,BITMAP_WIDTH,BITMAP_HEIGHT),_loc2_);
