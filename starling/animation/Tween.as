package starling.animation
{
   ...
   public class Tween extends EventDispatcher implements IAnimatable
   {
      ...
      // method body index: 3873 method index: 4194
      private static var sTweenPool:Vector.<Tween> = // method body index: 3873 method index: 4194
      new Vector.<Tween>(0);
      ...
      {
         // method body index: 3876 method index: 4197
         super();
      ...
      {
         // method body index: 3874 method index: 4195
      ...
      {
         // method body index: 3875 method index: 4196
      ...
      {
         // method body index: 3877 method index: 4198
         this.mTarget = param1;
         this.mCurrentTime = 0;
      ...
      {
         // method body index: 3878 method index: 4199
      ...
      {
         // method body index: 3879 method index: 4200
      ...
      {
         // method body index: 3880 method index: 4201
      ...
      {
         // method body index: 3881 method index: 4202
         this.animate("alpha",param1);
      }
      
      public function advanceTime(param1:Number) : void
      {
         // method body index: 3882 method index: 4203
         var _loc2_:int = 0;
         ...
         this.mProgress = _loc7_ ? Number(this.mTransitionFunc(1 - _loc6_)) : Number(this.mTransitionFunc(_loc6_));
         _loc2_ = 0;
         while(_loc2_ < _loc8_)
         {
            if(isNaN(this.mStartValues[_loc2_]))
            {
               this.mStartValues[_loc2_] = this.mTarget[this.mProperties[_loc2_]] as Number;
            }
            _loc9_ = this.mStartValues[_loc2_];
            _loc10_ = this.mEndValues[_loc2_];
      ...
      {
         // method body index: 3883 method index: 4204
      ...
      {
         // method body index: 3884 method index: 4205
         return this.mCurrentTime >= this.mTotalTime && this.mRepeatCount == 1;
      }
      
      public function get target() : Object
      {
         // method body index: 3885 method index: 4206
         return this.mTarget;
      }
      
      public function get transition() : String
      {
         // method body index: 3886 method index: 4207
         return this.mTransitionName;
      }
      
      public function set transition(param1:String) : void
      {
         // method body index: 3887 method index: 4208
      ...
      {
         // method body index: 3890 method index: 4211
         return this.mTotalTime;
      }
      
      public function get currentTime() : Number
      {
         // method body index: 3891 method index: 4212
         return this.mCurrentTime;
      }
      
      public function get progress() : Number
      {
         // method body index: 3892 method index: 4213
         return this.mProgress;
      }
      
      public function get delay() : Number
      {
         // method body index: 3893 method index: 4214
         return this.mDelay;
      }
      
      public function set delay(param1:Number) : void
      {
         // method body index: 3894 method index: 4215
