package zpp_nape.shape
{
   ...
   public class ZPP_Polygon extends ZPP_Shape
   {
      ...
      {
         // method body index: 5472 method index: 5854
      ...
      {
         // method body index: 5436 method index: 5856
         if(zip_lverts)
         {
            zip_lverts = false;
            if(lverts.length > 2)
      ...
      {
         // method body index: 5437 method index: 5857
      ...
      {
         // method body index: 5438 method index: 5859
      ...
      {
         // method body index: 5439 method index: 5860
      ...
      {
         // method body index: 5440 method index: 5861
         var _loc3_:* = null as ZPP_Vec2;
         var _loc4_:* = null as ZPP_Vec2;
         var _loc5_:* = null as ZPP_Vec2;
         var _loc6_:Number = NaN;
         ...
         while(_loc2_ != null)
         {
            ...
            if(_loc6_ * _loc6_ + _loc7_ * _loc7_ < 1e-16)
            {
      ...
      {
         // method body index: 5441 method index: 5863
      ...
      {
         // method body index: 5442 method index: 5864
         lverts.reverse();
         gverts.reverse();
         edges.reverse();
      ...
      {
         // method body index: 5446 method index: 5868
         invalidate_lverts();
      }
      
      public function lverts_pa_immutable() : void
      {
         // method body index: 5447 method index: 5869
      ...
      {
         // method body index: 5448 method index: 5870
      ...
      {
         // method body index: 5449 method index: 5871
         invalidate_lverts();
      }
      
      public function localCOM_validate() : void
      {
         // method body index: 5450 method index: 5872
      ...
      {
         // method body index: 5451 method index: 5873
         ...
         if(zip_localCOM)
         {
            ...
            if(type == ZPP_Flags.id_ShapeType_POLYGON)
            {
               ...
               else
               {
                  ...
                  _loc7_ = _loc4_ = _loc2_.lverts.next;
                  _loc3_ += _loc6_.x * (_loc7_.y - _loc5_.y);
                  _loc8_ = _loc7_.y * _loc6_.x - _loc7_.x * _loc6_.y;
                  _loc2_.localCOMx += (_loc6_.x + _loc7_.x) * _loc8_;
                  _loc2_.localCOMy += (_loc6_.y + _loc7_.y) * _loc8_;
      ...
      {
         // method body index: 5452 method index: 5874
         invalidate_laxi();
      ...
      {
         // method body index: 5453 method index: 5875
         invalidate_gaxi();
      ...
      {
         // method body index: 5454 method index: 5876
         zip_aabb = true;
         if(body != null)
         {
            body.zip_aabb = true;
      ...
      {
         // method body index: 5455 method index: 5877
         zip_gaxi = true;
      }
      
      public function gverts_validate() : void
      {
         // method body index: 5456 method index: 5878
         var _loc1_:* = null as ZPP_Body;
         var _loc2_:* = null as ZPP_Vec2;
         var _loc3_:* = null as ZPP_Vec2;
         var _loc4_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 5457 method index: 5879
         var _loc1_:* = null as ZPP_Body;
         var _loc2_:* = null as ZPP_Vec2;
         var _loc3_:* = null as ZPP_Vec2;
         var _loc4_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 5458 method index: 5880
      ...
      {
         // method body index: 5459 method index: 5881
         var _loc1_:ZPP_Polygon = this;
      ...
      {
         // method body index: 5460 method index: 5882
         var _loc1_:ZPP_Polygon = this;
      ...
      {
         // method body index: 5461 method index: 5883
         validate_lverts();
      }
      
      public function cleanup_lvert(param1:ZPP_Vec2) : void
      {
         // method body index: 5462 method index: 5884
         var _loc5_:* = null as ZPP_Vec2;
         var _loc6_:* = null as ZPP_Edge;
         var _loc7_:* = null as ZPP_Edge;
         var _loc2_:ZPP_Vec2 = null;
         ...
         if(edgeCnt == 2)
         {
            _loc7_ = _loc6_ = edges.pop_unsafe();
            _loc7_.polygon = null;
      ...
      {
         // method body index: 5463 method index: 5886
         var _loc4_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 5464 method index: 5888
      ...
      {
         // method body index: 5465 method index: 5889
         var _loc8_:* = null as ZPP_Vec2;
         ...
         var _loc6_:ZPP_Vec2 = lverts.next;
         var _loc7_:ZPP_Vec2 = _loc6_.next;
         while(_loc7_ != null)
         {
            _loc8_ = _loc7_;
            _loc9_ = _loc2_.elt;
            ...
            _loc1_ += _loc9_.length * 2.5 * material.dynamicFriction * _loc9_.lprojection * _loc9_.lprojection;
            ...
            if(_loc12_ > 0)
            {
               ...
               _loc1_ += _loc18_ * _loc13_ * _loc9_.length * 100;
            }
            if(_loc12_ < 1)
            {
               ...
               _loc18_ = (_loc17_ * _loc17_ * _loc17_ - _loc16_ * _loc16_ * _loc16_) / (3 * (_loc17_ - _loc16_));
               _loc1_ += _loc18_ * 0.5 * (1 - _loc13_) * _loc9_.length * 100;
            }
      ...
      {
         // method body index: 5466 method index: 5891
         var _loc4_:* = null as ZPP_Vec2;
         var _loc5_:Number = NaN;
         var _loc3_:ZPP_Vec2 = lverts.next;
         while(_loc3_ != null)
      ...
      {
         // method body index: 5467 method index: 5892
         var _loc3_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 5468 method index: 5893
         var _loc4_:* = null as ZPP_Vec2;
         var _loc3_:ZPP_Vec2 = lverts.next;
         while(_loc3_ != null)
         {
      ...
      {
         // method body index: 5469 method index: 5894
         var _loc4_:* = null as ZPP_Vec2;
         var _loc5_:Number = NaN;
         var _loc6_:Number = NaN;
         var _loc3_:ZPP_Vec2 = lverts.next;
      ...
      {
         // method body index: 5470 method index: 5895
      ...
      {
         // method body index: 5471 method index: 5896
      }
   }
}
