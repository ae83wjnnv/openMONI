package zpp_nape.shape
{
   ...
   public class ZPP_Shape extends ZPP_Interactor
   {
      ...
      {
         // method body index: 4037 method index: 4336
         ...
         zip_area_inertia = zip_angDrag = Boolean(zip_localCOM = Boolean(zip_sweepRadius = true));
         localCOMx = 0;
         localCOMy = 0;
         worldCOMx = 0;
         worldCOMy = 0;
      ...
      {
         // method body index: 4013 method index: 4339
         if(zip_sweepRadius)
         {
            zip_sweepRadius = false;
      ...
      {
         // method body index: 4014 method index: 4341
         if(zip_area_inertia)
         {
            zip_area_inertia = false;
            if(type == ZPP_Flags.id_ShapeType_CIRCLE)
      ...
      {
         // method body index: 4015 method index: 4342
      ...
      {
         // method body index: 4016 method index: 4344
         if(material != param1)
         {
      ...
      {
         // method body index: 4017 method index: 4345
      ...
      {
         // method body index: 4018 method index: 4346
         if(filter != param1)
         {
            if(body != null && body.space != null)
            {
      ...
      {
         // method body index: 4019 method index: 4347
         __iremovedFromSpace();
         material.shapes.remove(this);
         filter.shapes.remove(this);
         if(fluidProperties != null)
      ...
      {
         // method body index: 4024 method index: 4353
      ...
      {
         // method body index: 4025 method index: 4354
      ...
      {
         // method body index: 4026 method index: 4355
         if(fluidEnabled)
         {
            wake();
         }
      ...
      {
         // method body index: 4027 method index: 4356
         wake();
      }
      
      public function invalidate_area_inertia() : void
      {
         // method body index: 4028 method index: 4357
         var _loc1_:* = null as ZPP_Body;
      ...
      {
         // method body index: 4029 method index: 4358
         zip_angDrag = true;
      }
      
      public function getworldCOM() : void
      {
         // method body index: 4030 method index: 4360
      ...
      {
         // method body index: 4031 method index: 4362
      ...
      {
         // method body index: 4032 method index: 4363
         if(type == ZPP_Flags.id_ShapeType_CIRCLE)
         {
            circle.__clear();
         }
      ...
      {
         // method body index: 4033 method index: 4364
         __iaddedToSpace();
      ...
      {
         // method body index: 4034 method index: 4365
         invalidate_worldCOM();
         zip_aabb = true;
         if(body != null)
         {
      ...
      {
         // method body index: 4035 method index: 4366
      ...
      {
         // method body index: 4036 method index: 4367
