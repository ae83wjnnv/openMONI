package zpp_nape.callbacks
{
   ...
   public class ZPP_CbSet
   {
      ...
      // method body index: 3194 method index: 3366
      public static var zpp_pool:ZPP_CbSet = // method body index: 3204 method index: 3392
      null;
      ...
      {
         // method body index: 3203 method index: 3365
      ...
      {
         // method body index: 3188 method index: 3386
      ...
      {
         // method body index: 3189 method index: 3387
      ...
      {
         // method body index: 3190 method index: 3388
         ...
         if(_loc4_.nonemptyintersection(_loc5_,_loc4_.includes) && !_loc4_.nonemptyintersection(_loc5_,_loc4_.excludes))
         {
            §§pop();
            _loc4_ = param1.options2;
            _loc5_ = param3.cbTypes;
            §§push(_loc4_.nonemptyintersection(_loc5_,_loc4_.includes) && !_loc4_.nonemptyintersection(_loc5_,_loc4_.excludes));
         }
         if(!§§pop())
         {
            §§pop();
      ...
      {
         // method body index: 3191 method index: 3389
      ...
      {
         // method body index: 3192 method index: 3390
      ...
      {
         // method body index: 3193 method index: 3391
      ...
      {
         // method body index: 3195 method index: 3370
         if(zip_listeners)
         {
            zip_listeners = false;
      ...
      {
         // method body index: 3199 method index: 3374
         var _loc2_:* = null as ZPP_CbType;
         ...
         while(_loc1_ != null)
         {
            ...
            while(_loc5_ != null)
            {
               ...
               {
                  if(!(_loc8_ = _loc6_.options).nonemptyintersection(cbTypes,_loc8_.excludes) && _loc6_.space == manager.space)
                  {
                     _loc9_ = conlisteners;
      ...
      {
         // method body index: 3200 method index: 3375
         var _loc2_:* = null as ZPP_CbType;
      ...
      {
         // method body index: 3201 method index: 3376
      ...
      {
         // method body index: 3202 method index: 3384
