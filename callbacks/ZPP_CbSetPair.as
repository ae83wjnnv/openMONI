package zpp_nape.callbacks
{
   ...
   public class ZPP_CbSetPair
   {
      ...
      // method body index: 2945 method index: 3028
      public static var zpp_pool:ZPP_CbSetPair = // method body index: 2948 method index: 3040
      null;
      ...
      {
         // method body index: 2947 method index: 3027
      ...
      {
         // method body index: 2943 method index: 3038
      ...
      {
         // method body index: 2944 method index: 3039
      ...
      {
         // method body index: 2946 method index: 3037
         ...
         while(_loc1_ != null && _loc2_ != null)
         {
            ...
            if(_loc3_ == _loc4_)
            {
               ...
               _loc6_ = a.cbTypes;
               if(_loc5_.nonemptyintersection(_loc6_,_loc5_.includes) && !_loc5_.nonemptyintersection(_loc6_,_loc5_.excludes))
               {
                  §§pop();
                  _loc5_ = _loc3_.options2;
                  _loc6_ = b.cbTypes;
                  §§push(_loc5_.nonemptyintersection(_loc6_,_loc5_.includes) && !_loc5_.nonemptyintersection(_loc6_,_loc5_.excludes));
               }
               if(!§§pop())
               {
                  §§pop();
