package nape.phys
{
   ...
   public final class CompoundIterator
   {
      ...
      // method body index: 3077 method index: 3194
      public static var zpp_pool:CompoundIterator = // method body index: 3081 method index: 3198
      null;
      ...
      {
         // method body index: 3080 method index: 3193
      ...
      {
         // method body index: 3076 method index: 3197
      ...
      {
         // method body index: 3078 method index: 3195
         zpp_critical = false;
      ...
      {
         // method body index: 3079 method index: 3196
