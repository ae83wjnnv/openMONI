package nape.phys
{
   ...
   public final class CompoundList
   {
      ...
      {
         // method body index: 4511 method index: 4860
      ...
      {
         // method body index: 4491 method index: 4879
      ...
      {
         // method body index: 4492 method index: 4880
         var _loc4_:* = null as Compound;
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 4494 method index: 4862
      ...
      {
         // method body index: 4495 method index: 4863
         var _loc4_:* = null as Compound;
         var _loc5_:int = 0;
      ...
      {
         // method body index: 4496 method index: 4864
      ...
      {
         // method body index: 4497 method index: 4865
      ...
      {
         // method body index: 4498 method index: 4866
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Compound" + "List is immutable";
      ...
      {
         // method body index: 4499 method index: 4867
      ...
      {
         // method body index: 4500 method index: 4868
         var _loc3_:* = null as Compound;
         var _loc4_:int = 0;
      ...
      {
         // method body index: 4501 method index: 4869
         zpp_inner.valmod();
      ...
      {
         // method body index: 4502 method index: 4870
         zpp_inner.valmod();
      ...
      {
         // method body index: 4503 method index: 4871
         zpp_inner.valmod();
         if(zpp_inner.zip_length)
         {
            zpp_inner.zip_length = false;
      ...
      {
         // method body index: 4504 method index: 4872
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc6_:* = null as CompoundList;
         if(param1 == null)
      ...
      {
         // method body index: 4505 method index: 4873
         var _loc4_:* = null as Compound;
         var _loc5_:* = null;
         if(param1 == null)
         {
      ...
      {
         // method body index: 4508 method index: 4876
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Compound" + "List is immutable";
      ...
      {
         // method body index: 4509 method index: 4877
         zpp_inner.valmod();
      ...
      {
         // method body index: 4510 method index: 4878
