package nape.phys
{
   ...
   public final class BodyList
   {
      ...
      {
         // method body index: 2192 method index: 2177
      ...
      {
         // method body index: 2172 method index: 2196
      ...
      {
         // method body index: 2173 method index: 2197
         var _loc4_:* = null as Body;
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 2175 method index: 2179
      ...
      {
         // method body index: 2176 method index: 2180
         var _loc4_:* = null as Body;
         var _loc5_:int = 0;
      ...
      {
         // method body index: 2177 method index: 2181
      ...
      {
         // method body index: 2178 method index: 2182
      ...
      {
         // method body index: 2179 method index: 2183
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Body" + "List is immutable";
      ...
      {
         // method body index: 2180 method index: 2184
      ...
      {
         // method body index: 2181 method index: 2185
         var _loc3_:* = null as Body;
         var _loc4_:int = 0;
      ...
      {
         // method body index: 2182 method index: 2186
         zpp_inner.valmod();
      ...
      {
         // method body index: 2183 method index: 2187
         zpp_inner.valmod();
      ...
      {
         // method body index: 2184 method index: 2188
         zpp_inner.valmod();
         if(zpp_inner.zip_length)
         {
            zpp_inner.zip_length = false;
      ...
      {
         // method body index: 2185 method index: 2189
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc6_:* = null as BodyList;
         if(param1 == null)
      ...
      {
         // method body index: 2186 method index: 2190
         var _loc4_:* = null as Body;
         var _loc5_:* = null;
         if(param1 == null)
         {
      ...
      {
         // method body index: 2189 method index: 2193
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Body" + "List is immutable";
      ...
      {
         // method body index: 2190 method index: 2194
         zpp_inner.valmod();
      ...
      {
         // method body index: 2191 method index: 2195
