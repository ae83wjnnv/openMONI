package nape.dynamics
{
   ...
   public final class CollisionArbiter extends Arbiter
   {
      ...
      {
         // method body index: 3983 method index: 4284
      ...
      {
         // method body index: 3964 method index: 4286
      ...
      {
         // method body index: 3965 method index: 4287
         var _loc7_:* = null as Vec3;
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         var _loc10_:* = null as ZPP_Vec3;
      ...
      {
         // method body index: 3966 method index: 4288
         ...
         if(_loc2_.invalidated)
         {
            ...
            if(!_loc2_.userdef_dyn_fric)
            {
               ...
               _loc4_ = lf32(0);
               var _temp_2:*;
               §§pop().dyn_fric = _loc3_ == 0 ? 0 : (_temp_2 = 1,sf32(_loc3_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_2 / (_loc4_ * (1.5 - 0.5 * _loc3_ * _loc4_ * _loc4_)));
            }
            if(!_loc2_.userdef_stat_fric)
            {
               ...
               _loc4_ = lf32(0);
               var _temp_4:*;
               §§pop().stat_fric = _loc3_ == 0 ? 0 : (_temp_4 = 1,sf32(_loc3_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_4 / (_loc4_ * (1.5 - 0.5 * _loc3_ * _loc4_ * _loc4_)));
            }
            if(!_loc2_.userdef_rfric)
            {
               ...
               _loc4_ = lf32(0);
               var _temp_6:*;
               §§pop().rfric = _loc3_ == 0 ? 0 : (_temp_6 = 1,sf32(_loc3_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_6 / (_loc4_ * (1.5 - 0.5 * _loc3_ * _loc4_ * _loc4_)));
            }
         }
      ...
      {
         // method body index: 3967 method index: 4289
         var _loc3_:Number = NaN;
         var _loc4_:Number = NaN;
         if(!zpp_inner.colarb.mutable)
         {
      ...
      {
         // method body index: 3968 method index: 4290
         var _loc3_:Number = NaN;
         var _loc4_:Number = NaN;
         if(!zpp_inner.colarb.mutable)
         {
      ...
      {
         // method body index: 3969 method index: 4291
         var _loc3_:Number = NaN;
         var _loc4_:Number = NaN;
         if(!zpp_inner.colarb.mutable)
         {
      ...
      {
         // method body index: 3970 method index: 4292
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 3971 method index: 4293
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 3972 method index: 4294
         var _loc7_:* = null as Vec3;
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         var _loc10_:* = null as ZPP_Vec3;
      ...
      {
         // method body index: 3973 method index: 4295
         ...
         if(_loc1_.invalidated)
         {
            ...
            if(!_loc1_.userdef_dyn_fric)
            {
               ...
               var _temp_1:*;
               §§pop().dyn_fric = _loc2_ == 0 ? 0 : (_temp_1 = 1,sf32(_loc2_,0),si32(1597463007 - (li32(0) >> 1),0),_loc3_ = lf32(0),_temp_1 / (_loc3_ * (1.5 - 0.5 * _loc2_ * _loc3_ * _loc3_)));
            }
            if(!_loc1_.userdef_stat_fric)
            {
               ...
               var _temp_2:*;
               §§pop().stat_fric = _loc2_ == 0 ? 0 : (_temp_2 = 1,sf32(_loc2_,0),si32(1597463007 - (li32(0) >> 1),0),_loc3_ = lf32(0),_temp_2 / (_loc3_ * (1.5 - 0.5 * _loc2_ * _loc3_ * _loc3_)));
            }
            if(!_loc1_.userdef_rfric)
            {
               ...
               var _temp_3:*;
               §§pop().rfric = _loc2_ == 0 ? 0 : (_temp_3 = 1,sf32(_loc2_,0),si32(1597463007 - (li32(0) >> 1),0),_loc3_ = lf32(0),_temp_3 / (_loc3_ * (1.5 - 0.5 * _loc2_ * _loc3_ * _loc3_)));
            }
         }
      ...
      {
         // method body index: 3974 method index: 4296
         var _loc2_:Number = NaN;
         var _loc3_:Number = NaN;
         if(!zpp_inner.active)
         {
      ...
      {
         // method body index: 3975 method index: 4297
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 3976 method index: 4298
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 3977 method index: 4299
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 3978 method index: 4300
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 3979 method index: 4301
         var _loc2_:Number = NaN;
         var _loc3_:Number = NaN;
         if(!zpp_inner.active)
         {
      ...
      {
         // method body index: 3980 method index: 4302
         var _loc2_:Number = NaN;
         var _loc3_:Number = NaN;
         if(!zpp_inner.active)
         {
      ...
      {
         // method body index: 3981 method index: 4303
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 3982 method index: 4304
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
