package nape.dynamics
{
   ...
   public final class InteractionFilter
   {
      ...
      {
         // method body index: 2127 method index: 2111
      ...
      {
         // method body index: 2108 method index: 2113
      ...
      {
         // method body index: 2109 method index: 2114
         if(param1 == null)
         {
      ...
      {
         // method body index: 2110 method index: 2115
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 2111 method index: 2116
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 2112 method index: 2117
      ...
      {
         // method body index: 2113 method index: 2118
      ...
      {
         // method body index: 2114 method index: 2119
      ...
      {
         // method body index: 2115 method index: 2120
      ...
      {
         // method body index: 2116 method index: 2121
      ...
      {
         // method body index: 2117 method index: 2122
         if(zpp_inner.collisionGroup != param1)
         {
            zpp_inner.collisionGroup = param1;
            zpp_inner.invalidate();
      ...
      {
         // method body index: 2118 method index: 2123
      ...
      {
         // method body index: 2119 method index: 2124
      ...
      {
         // method body index: 2120 method index: 2125
         return zpp_inner.sensorMask;
      }
      
      public function get sensorGroup() : int
      {
         // method body index: 2121 method index: 2126
         return zpp_inner.sensorGroup;
      }
      
      public function get fluidMask() : int
      {
         // method body index: 2122 method index: 2127
         return zpp_inner.fluidMask;
      }
      
      public function get fluidGroup() : int
      {
         // method body index: 2123 method index: 2128
         return zpp_inner.fluidGroup;
      }
      
      public function get collisionMask() : int
      {
         // method body index: 2124 method index: 2129
         return zpp_inner.collisionMask;
      }
      
      public function get collisionGroup() : int
      {
         // method body index: 2125 method index: 2130
         return zpp_inner.collisionGroup;
      }
      
      public function copy() : InteractionFilter
      {
         // method body index: 2126 method index: 2132
