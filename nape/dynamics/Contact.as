package nape.dynamics
{
   ...
   public final class Contact
   {
      ...
      {
         // method body index: 5152 method index: 5517
      ...
      {
         // method body index: 5142 method index: 5519
      ...
      {
         // method body index: 5143 method index: 5520
      ...
      {
         // method body index: 5144 method index: 5521
         if(zpp_inner.inactiveme())
         {
            Boot.lastError = new Error();
            throw "Error: Contact not currently in use";
      ...
      {
         // method body index: 5145 method index: 5522
         if(zpp_inner.inactiveme())
         {
            Boot.lastError = new Error();
            throw "Error: Contact not currently in use";
      ...
      {
         // method body index: 5146 method index: 5523
         if(zpp_inner.inactiveme())
         {
            Boot.lastError = new Error();
            throw "Error: Contact not currently in use";
      ...
      {
         // method body index: 5147 method index: 5524
         if(zpp_inner.inactiveme())
         {
            Boot.lastError = new Error();
            throw "Error: Contact not currently in use";
      ...
      {
         // method body index: 5148 method index: 5525
         if(zpp_inner.inactiveme())
         {
            Boot.lastError = new Error();
            throw "Error: Contact not currently in use";
      ...
      {
         // method body index: 5149 method index: 5526
         if(zpp_inner.inactiveme())
         {
            Boot.lastError = new Error();
            throw "Error: Contact not currently in use";
      ...
      {
         // method body index: 5150 method index: 5527
         if(zpp_inner.inactiveme())
         {
            Boot.lastError = new Error();
            throw "Error: Contact not currently in use";
      ...
      {
         // method body index: 5151 method index: 5528
