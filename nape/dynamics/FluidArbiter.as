package nape.dynamics
{
   ...
   public final class FluidArbiter extends Arbiter
   {
      ...
      {
         // method body index: 5081 method index: 5443
      ...
      {
         // method body index: 5074 method index: 5445
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
         ...
         var _loc4_:Vec3;
         var _loc5_:Vec3 = _loc4_ = dragImpulse(param1);
      ...
      {
         // method body index: 5075 method index: 5446
      ...
      {
         // method body index: 5076 method index: 5447
         if(!zpp_inner.fluidarb.mutable)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter is mutable only within a pre-handler";
      ...
      {
         // method body index: 5077 method index: 5448
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 5078 method index: 5449
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 5079 method index: 5450
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 5080 method index: 5451
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
