package nape.dynamics
{
   ...
   public final class ContactList
   {
      ...
      {
         // method body index: 5103 method index: 5453
      ...
      {
         // method body index: 5083 method index: 5472
      ...
      {
         // method body index: 5084 method index: 5473
         var _loc4_:* = null as Contact;
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 5086 method index: 5455
      ...
      {
         // method body index: 5087 method index: 5456
         var _loc4_:* = null as Contact;
         var _loc5_:int = 0;
         ...
         while(true)
         {
            ...
            var _temp_4:* = _loc3_.zpp_inner;
            _loc3_.zpp_i = (_loc5_ = _loc3_.zpp_i) + 1;
            _loc4_ = _temp_4.at(_loc5_);
            if(!_loc2_)
            {
               _loc1_ += ",";
            }
      ...
      {
         // method body index: 5088 method index: 5457
      ...
      {
         // method body index: 5089 method index: 5458
         var _loc4_:* = null as ZPP_Contact;
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 5090 method index: 5459
         var _loc3_:* = null as ZPP_Contact;
         var _loc4_:* = null as ZPP_Contact;
         if(zpp_inner.immutable)
         {
      ...
      {
         // method body index: 5091 method index: 5460
         var _loc1_:* = null as ZPP_Contact;
         var _loc2_:* = null as ZPP_Contact;
      ...
      {
         // method body index: 5092 method index: 5461
         var _loc3_:* = null as Contact;
         var _loc4_:int = 0;
         ...
         while(true)
         {
            ...
            var _temp_4:* = _loc2_.zpp_inner;
            _loc2_.zpp_i = (_loc4_ = _loc2_.zpp_i) + 1;
            _loc3_ = _temp_4.at(_loc4_);
            if(!has(_loc3_))
            {
               if(zpp_inner.reverse_flag)
               {
      ...
      {
         // method body index: 5093 method index: 5462
         zpp_inner.valmod();
      ...
      {
         // method body index: 5094 method index: 5463
         zpp_inner.valmod();
      ...
      {
         // method body index: 5095 method index: 5464
         var _loc1_:* = null as ZPP_Contact;
         var _loc2_:* = null as ZPP_Contact;
         zpp_inner.valmod();
         if(zpp_inner.zip_length)
      ...
      {
         // method body index: 5096 method index: 5465
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc6_:* = null as ContactList;
         var _loc7_:* = null as ZPP_Contact;
      ...
      {
         // method body index: 5097 method index: 5466
         var _loc4_:* = null as Contact;
         var _loc5_:* = null;
         var _loc6_:* = null as ZPP_Contact;
         var _loc7_:* = null as ZPP_Contact;
      ...
      {
         // method body index: 5098 method index: 5467
         var _loc1_:* = null as ZPP_Contact;
         var _loc2_:* = null as ZPP_Contact;
         zpp_inner.valmod();
         if(zpp_inner.zip_length)
      ...
      {
         // method body index: 5099 method index: 5468
         var _loc4_:* = null as Contact;
         var _loc5_:int = 0;
         var _loc6_:* = null as ContactList;
         var _loc7_:* = null as ZPP_Contact;
      ...
      {
         // method body index: 5100 method index: 5469
         var _loc1_:* = null as ZPP_Contact;
         var _loc2_:* = null as ZPP_Contact;
         if(zpp_inner.immutable)
         {
      ...
      {
         // method body index: 5101 method index: 5470
         var _loc2_:* = null as ZPP_Contact;
         var _loc3_:* = null as ZPP_Contact;
         zpp_inner.valmod();
      ...
      {
         // method body index: 5102 method index: 5471
