package nape.dynamics
{
   ...
   public class Arbiter
   {
      ...
      {
         // method body index: 3961 method index: 4267
      ...
      {
         // method body index: 3947 method index: 4269
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 3948 method index: 4270
         var _loc2_:int = 0;
      ...
      {
         // method body index: 3953 method index: 4275
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 3954 method index: 4276
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 3955 method index: 4277
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 3956 method index: 4278
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
      ...
      {
         // method body index: 3957 method index: 4279
      ...
      {
         // method body index: 3960 method index: 4282
         if(!zpp_inner.active)
         {
            Boot.lastError = new Error();
            throw "Error: Arbiter not currently in use";
