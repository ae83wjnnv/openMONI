package nape.dynamics
{
   ...
   public final class InteractionGroupList
   {
      ...
      {
         // method body index: 5589 method index: 5993
      ...
      {
         // method body index: 5569 method index: 6012
      ...
      {
         // method body index: 5570 method index: 6013
         var _loc4_:* = null as InteractionGroup;
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 5572 method index: 5995
      ...
      {
         // method body index: 5573 method index: 5996
         var _loc4_:* = null as InteractionGroup;
         var _loc5_:int = 0;
      ...
      {
         // method body index: 5574 method index: 5997
      ...
      {
         // method body index: 5575 method index: 5998
      ...
      {
         // method body index: 5576 method index: 5999
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "InteractionGroup" + "List is immutable";
      ...
      {
         // method body index: 5577 method index: 6000
      ...
      {
         // method body index: 5578 method index: 6001
         var _loc3_:* = null as InteractionGroup;
         var _loc4_:int = 0;
      ...
      {
         // method body index: 5579 method index: 6002
         zpp_inner.valmod();
      ...
      {
         // method body index: 5580 method index: 6003
         zpp_inner.valmod();
      ...
      {
         // method body index: 5581 method index: 6004
         zpp_inner.valmod();
         if(zpp_inner.zip_length)
         {
            zpp_inner.zip_length = false;
      ...
      {
         // method body index: 5582 method index: 6005
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc6_:* = null as InteractionGroupList;
         if(param1 == null)
      ...
      {
         // method body index: 5583 method index: 6006
         var _loc4_:* = null as InteractionGroup;
         var _loc5_:* = null;
         if(param1 == null)
         {
      ...
      {
         // method body index: 5586 method index: 6009
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "InteractionGroup" + "List is immutable";
      ...
      {
         // method body index: 5587 method index: 6010
         zpp_inner.valmod();
      ...
      {
         // method body index: 5588 method index: 6011
