package nape.util
{
   ...
   public final class BitmapDebug extends Debug
   {
      ...
      {
         // method body index: 6830 method index: 7417
      ...
      override public function drawSpring(param1:Vec2, param2:Vec2, param3:int, param4:int = 3, param5:Number = 3) : void
      {
         ...
         else
         {
            ...
            _loc13_ = lf32(0);
            _loc13_ = _loc12_ = _loc13_ * (1.5 - 0.5 * _loc11_ * _loc13_ * _loc13_);
            _loc9_ *= _loc13_;
            _loc10_ *= _loc13_;
            _loc11_ = _loc9_;
            _loc9_ = -_loc10_;
      ...
      {
         // method body index: 6820 method index: 7423
         ...
         if(param1 is Array)
         {
            ...
            while(_loc10_ < int(_loc9_.length))
            {
               ...
               else
               {
                  ...
                  _loc13_ = _loc20_.zpp_inner.x + 0.5;
                  if(_loc20_ != null && _loc20_.zpp_disp)
                  {
                     Boot.lastError = new Error();
                     throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
                  ...
                  _loc14_ = _loc20_.zpp_inner.y + 0.5;
                  if(_loc15_)
                  {
                     _loc6_ = _loc20_;
                  }
         ...
         else if(param1 is ZPP_Const.vec2vector)
         {
            ...
            while(_loc10_ < _loc24_.length)
            {
               ...
               else
               {
                  ...
                  _loc13_ = _loc22_.zpp_inner.x + 0.5;
                  if(_loc22_ != null && _loc22_.zpp_disp)
                  {
                     Boot.lastError = new Error();
                     throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
                  ...
                  _loc14_ = _loc22_.zpp_inner.y + 0.5;
                  if(_loc15_)
                  {
                     _loc6_ = _loc22_;
                  }
         ...
         else if(param1 is Vec2List)
         {
            ...
            while(true)
            {
               ...
               var _temp_35:* = _loc27_.zpp_inner;
               _loc27_.zpp_i = (_loc10_ = _loc27_.zpp_i) + 1;
               _loc12_ = _temp_35.at(_loc10_);
               if(_loc12_ == null)
               {
                  Boot.lastError = new Error();
               ...
               else
               {
                  ...
                  _loc10_ = _loc20_.zpp_inner.x + 0.5;
                  if(_loc20_ != null && _loc20_.zpp_disp)
                  {
                     Boot.lastError = new Error();
                     throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
                  ...
                  _loc13_ = _loc20_.zpp_inner.y + 0.5;
                  if(_loc15_)
                  {
                     _loc6_ = _loc20_;
                  }
      ...
      {
         // method body index: 6821 method index: 7424
         var _loc4_:int = 0;
      ...
      {
         // method body index: 6822 method index: 7425
         var _loc5_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 6823 method index: 7426
         ...
         else if(param1 is Vec2List)
         {
            ...
            while(true)
            {
               ...
               var _temp_25:* = _loc21_.zpp_inner;
               _loc21_.zpp_i = (_loc8_ = _loc21_.zpp_i) + 1;
               _loc10_ = _temp_25.at(_loc8_);
               if(_loc10_ == null)
               {
                  Boot.lastError = new Error();
                  throw "Error: Vec2List contains null objects";
      ...
      {
         // method body index: 6824 method index: 7427
         var _loc4_:int = 0;
         var _loc5_:* = null as ZPP_Vec2;
         var _loc6_:int = 0;
         var _loc7_:int = 0;
      ...
      {
         // method body index: 6825 method index: 7428
         var _loc5_:* = null as ZPP_Vec2;
         var _loc6_:* = null as Vec2;
         var _loc7_:* = null as ZPP_Vec2;
         var _loc8_:* = null as Vec2;
      ...
      {
         // method body index: 6826 method index: 7429
         var _loc4_:int = 0;
         var _loc5_:* = null as ZPP_Vec2;
         var _loc6_:int = 0;
         var _loc7_:int = 0;
      ...
      {
         // method body index: 6827 method index: 7430
      ...
      {
         // method body index: 6828 method index: 7431
         if(zpp_inner.xform != null && !zpp_inner.xform.outer.equiorthogonal())
         {
            Boot.lastError = new Error();
            throw "Error: Debug draw can only operate with an equiorthogonal transform!";
      ...
      {
         // method body index: 6829 method index: 7432
         zpp_inner_zn.clear();
      }
   }
}
