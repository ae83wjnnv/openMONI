package nape.util
{
   ...
   public class Debug
   {
      ...
      {
         // method body index: 1683 method index: 1662
      ...
      {
         // method body index: 1662 method index: 1681
         return "Nape 2.0.0";
      }
      
      public static function clearObjectPools() : void
      {
         // method body index: 1663 method index: 1682
         ...
         var _loc20_:* = null as ZPP_FluidProperties;
         var _loc21_:* = null as ZNPNode_ZPP_Arbiter;
         var _loc22_:* = null as ZNPNode_ZPP_Constraint;
         var _loc23_:* = null as ZNPNode_ZPP_Body;
         var _loc24_:* = null as ZPP_Set_ZPP_Body;
         ...
         var _loc29_:* = null as ZNPNode_ZPP_Interactor;
         var _loc30_:* = null as ZPP_Callback;
         var _loc31_:* = null as ZPP_CbSet;
         var _loc32_:* = null as ZNPNode_ZPP_CbSetPair;
         var _loc33_:* = null as ZNPNode_ZPP_BodyListener;
         var _loc34_:* = null as ZNPNode_ZPP_ConstraintListener;
         var _loc35_:* = null as ZPP_GeomVert;
         var _loc36_:* = null as ZPP_GeomVertexIterator;
         var _loc37_:* = null as ZPP_Mat23;
         var _loc38_:* = null as ZPP_CutVert;
         var _loc39_:* = null as ZPP_CutInt;
         var _loc40_:* = null as ZNPNode_ZPP_CutInt;
         var _loc41_:* = null as ZPP_Set_ZPP_CbSetPair;
         ...
         var _loc49_:* = null as ZPP_Set_ZPP_PartitionPair;
         var _loc50_:* = null as ZNPNode_ZPP_PartitionedPoly;
         var _loc51_:* = null as ZPP_SimplifyV;
         var _loc52_:* = null as ZNPNode_ZPP_GeomVert;
         ...
         var _loc61_:* = null as ZPP_Set_ZPP_SimpleEvent;
         var _loc62_:* = null as ZPP_MarchSpan;
         var _loc63_:* = null as ZPP_MarchPair;
         var _loc64_:* = null as ZPP_SimpleEvent;
         var _loc65_:* = null as Hashable2_Boolfalse;
         var _loc66_:* = null as ZNPNode_ZPP_SimpleVert;
         var _loc67_:* = null as ZNPNode_ZPP_SimpleEvent;
         var _loc68_:* = null as ZNPNode_ZPP_AABBPair;
         var _loc69_:* = null as ZPP_Edge;
         var _loc70_:* = null as ZNPNode_ZPP_Edge;
         var _loc71_:* = null as ZNPNode_ZPP_Vec2;
         ...
         var _loc76_:* = null as ZNPNode_ZPP_Component;
         var _loc77_:* = null as ZNPNode_ZPP_AABBNode;
         ...
         var _loc82_:* = null as ZPP_SensorArbiter;
         var _loc83_:* = null as ZPP_FluidArbiter;
         var _loc84_:* = null as ZNPNode_ZPP_FluidArbiter;
         var _loc85_:* = null as ZNPNode_ZPP_SensorArbiter;
         var _loc86_:* = null as ZNPNode_ZPP_Listener;
         var _loc87_:* = null as ZPP_ColArbiter;
         var _loc88_:* = null as ZNPNode_ZPP_ColArbiter;
         var _loc89_:* = null as ZNPNode_ZPP_ToiEvent;
         var _loc90_:* = null as ZNPNode_ZPP_InteractionGroup;
         var _loc91_:* = null as ZPP_InteractionFilter;
         ...
         {
            _loc20_ = ZPP_FluidProperties.zpp_pool.next;
            ZPP_FluidProperties.zpp_pool.next = null;
            ZPP_FluidProperties.zpp_pool = _loc20_;
         }
         while(ZNPNode_ZPP_Arbiter.zpp_pool != null)
         {
            _loc21_ = ZNPNode_ZPP_Arbiter.zpp_pool.next;
            ZNPNode_ZPP_Arbiter.zpp_pool.next = null;
            ZNPNode_ZPP_Arbiter.zpp_pool = _loc21_;
         }
         while(ZNPNode_ZPP_Constraint.zpp_pool != null)
         {
            _loc22_ = ZNPNode_ZPP_Constraint.zpp_pool.next;
            ZNPNode_ZPP_Constraint.zpp_pool.next = null;
            ZNPNode_ZPP_Constraint.zpp_pool = _loc22_;
         }
         while(ZNPNode_ZPP_Body.zpp_pool != null)
         {
            _loc23_ = ZNPNode_ZPP_Body.zpp_pool.next;
            ZNPNode_ZPP_Body.zpp_pool.next = null;
            ZNPNode_ZPP_Body.zpp_pool = _loc23_;
         }
         while(ZPP_Set_ZPP_Body.zpp_pool != null)
         {
            _loc24_ = ZPP_Set_ZPP_Body.zpp_pool.next;
            ZPP_Set_ZPP_Body.zpp_pool.next = null;
            ZPP_Set_ZPP_Body.zpp_pool = _loc24_;
         }
         ...
         {
            _loc39_ = ZPP_CutInt.zpp_pool.next;
            ZPP_CutInt.zpp_pool.next = null;
            ZPP_CutInt.zpp_pool = _loc39_;
         }
         while(ZNPNode_ZPP_CutInt.zpp_pool != null)
         {
            _loc40_ = ZNPNode_ZPP_CutInt.zpp_pool.next;
            ZNPNode_ZPP_CutInt.zpp_pool.next = null;
            ZNPNode_ZPP_CutInt.zpp_pool = _loc40_;
         }
         while(ZPP_Set_ZPP_CbSetPair.zpp_pool != null)
         {
            _loc41_ = ZPP_Set_ZPP_CbSetPair.zpp_pool.next;
            ZPP_Set_ZPP_CbSetPair.zpp_pool.next = null;
            ZPP_Set_ZPP_CbSetPair.zpp_pool = _loc41_;
         }
         while(ZNPNode_ZPP_CutVert.zpp_pool != null)
         {
            _loc42_ = ZNPNode_ZPP_CutVert.zpp_pool.next;
            ZNPNode_ZPP_CutVert.zpp_pool.next = null;
            ZNPNode_ZPP_CutVert.zpp_pool = _loc42_;
         }
         while(ZPP_Vec2.zpp_pool != null)
         {
            _loc43_ = ZPP_Vec2.zpp_pool.next;
            ZPP_Vec2.zpp_pool.next = null;
            ZPP_Vec2.zpp_pool = _loc43_;
         }
         ...
         {
            _loc49_ = ZPP_Set_ZPP_PartitionPair.zpp_pool.next;
            ZPP_Set_ZPP_PartitionPair.zpp_pool.next = null;
            ZPP_Set_ZPP_PartitionPair.zpp_pool = _loc49_;
         }
         while(ZNPNode_ZPP_PartitionedPoly.zpp_pool != null)
         {
            _loc50_ = ZNPNode_ZPP_PartitionedPoly.zpp_pool.next;
            ZNPNode_ZPP_PartitionedPoly.zpp_pool.next = null;
            ZNPNode_ZPP_PartitionedPoly.zpp_pool = _loc50_;
         }
         while(ZPP_SimplifyV.zpp_pool != null)
         {
            _loc51_ = ZPP_SimplifyV.zpp_pool.next;
            ZPP_SimplifyV.zpp_pool.next = null;
            ZPP_SimplifyV.zpp_pool = _loc51_;
         }
         while(ZNPNode_ZPP_GeomVert.zpp_pool != null)
         {
            _loc52_ = ZNPNode_ZPP_GeomVert.zpp_pool.next;
            ZNPNode_ZPP_GeomVert.zpp_pool.next = null;
            ZNPNode_ZPP_GeomVert.zpp_pool = _loc52_;
         }
         ...
         {
            _loc56_ = ZPP_ToiEvent.zpp_pool.next;
            ZPP_ToiEvent.zpp_pool.next = null;
            ZPP_ToiEvent.zpp_pool = _loc56_;
         }
         while(ZPP_Set_ZPP_SimpleVert.zpp_pool != null)
         {
            _loc57_ = ZPP_Set_ZPP_SimpleVert.zpp_pool.next;
            ZPP_Set_ZPP_SimpleVert.zpp_pool.next = null;
            ZPP_Set_ZPP_SimpleVert.zpp_pool = _loc57_;
         }
         while(ZPP_SimpleVert.zpp_pool != null)
         {
            _loc58_ = ZPP_SimpleVert.zpp_pool.next;
            ZPP_SimpleVert.zpp_pool.next = null;
            ZPP_SimpleVert.zpp_pool = _loc58_;
         }
         while(ZPP_SimpleSeg.zpp_pool != null)
         {
            _loc59_ = ZPP_SimpleSeg.zpp_pool.next;
            ZPP_SimpleSeg.zpp_pool.next = null;
            ZPP_SimpleSeg.zpp_pool = _loc59_;
         }
         while(ZPP_Set_ZPP_SimpleSeg.zpp_pool != null)
         {
            _loc60_ = ZPP_Set_ZPP_SimpleSeg.zpp_pool.next;
            ZPP_Set_ZPP_SimpleSeg.zpp_pool.next = null;
            ZPP_Set_ZPP_SimpleSeg.zpp_pool = _loc60_;
         }
         while(ZPP_Set_ZPP_SimpleEvent.zpp_pool != null)
         {
            _loc61_ = ZPP_Set_ZPP_SimpleEvent.zpp_pool.next;
            ZPP_Set_ZPP_SimpleEvent.zpp_pool.next = null;
            ZPP_Set_ZPP_SimpleEvent.zpp_pool = _loc61_;
         }
         while(ZPP_MarchSpan.zpp_pool != null)
         {
            _loc62_ = ZPP_MarchSpan.zpp_pool.next;
            ZPP_MarchSpan.zpp_pool.next = null;
            ZPP_MarchSpan.zpp_pool = _loc62_;
         }
         while(ZPP_MarchPair.zpp_pool != null)
         {
            _loc63_ = ZPP_MarchPair.zpp_pool.next;
            ZPP_MarchPair.zpp_pool.next = null;
            ZPP_MarchPair.zpp_pool = _loc63_;
         }
         while(ZPP_SimpleEvent.zpp_pool != null)
         {
            _loc64_ = ZPP_SimpleEvent.zpp_pool.next;
            ZPP_SimpleEvent.zpp_pool.next = null;
            ZPP_SimpleEvent.zpp_pool = _loc64_;
         }
         while(Hashable2_Boolfalse.zpp_pool != null)
         {
            _loc65_ = Hashable2_Boolfalse.zpp_pool.next;
            Hashable2_Boolfalse.zpp_pool.next = null;
            Hashable2_Boolfalse.zpp_pool = _loc65_;
         }
         while(ZNPNode_ZPP_SimpleVert.zpp_pool != null)
         {
            _loc66_ = ZNPNode_ZPP_SimpleVert.zpp_pool.next;
            ZNPNode_ZPP_SimpleVert.zpp_pool.next = null;
            ZNPNode_ZPP_SimpleVert.zpp_pool = _loc66_;
         }
         while(ZNPNode_ZPP_SimpleEvent.zpp_pool != null)
         {
            _loc67_ = ZNPNode_ZPP_SimpleEvent.zpp_pool.next;
            ZNPNode_ZPP_SimpleEvent.zpp_pool.next = null;
            ZNPNode_ZPP_SimpleEvent.zpp_pool = _loc67_;
         }
         while(ZNPNode_ZPP_AABBPair.zpp_pool != null)
         {
            _loc68_ = ZNPNode_ZPP_AABBPair.zpp_pool.next;
            ZNPNode_ZPP_AABBPair.zpp_pool.next = null;
            ZNPNode_ZPP_AABBPair.zpp_pool = _loc68_;
         }
         ...
         {
            _loc70_ = ZNPNode_ZPP_Edge.zpp_pool.next;
            ZNPNode_ZPP_Edge.zpp_pool.next = null;
            ZNPNode_ZPP_Edge.zpp_pool = _loc70_;
         }
         while(ZNPNode_ZPP_Vec2.zpp_pool != null)
         {
            _loc71_ = ZNPNode_ZPP_Vec2.zpp_pool.next;
            ZNPNode_ZPP_Vec2.zpp_pool.next = null;
            ZNPNode_ZPP_Vec2.zpp_pool = _loc71_;
         }
         ...
         {
            _loc76_ = ZNPNode_ZPP_Component.zpp_pool.next;
            ZNPNode_ZPP_Component.zpp_pool.next = null;
            ZNPNode_ZPP_Component.zpp_pool = _loc76_;
         }
         while(ZNPNode_ZPP_AABBNode.zpp_pool != null)
         {
            _loc77_ = ZNPNode_ZPP_AABBNode.zpp_pool.next;
            ZNPNode_ZPP_AABBNode.zpp_pool.next = null;
            ZNPNode_ZPP_AABBNode.zpp_pool = _loc77_;
         }
         ...
         {
            _loc81_ = ZPP_Set_ZPP_CbSet.zpp_pool.next;
            ZPP_Set_ZPP_CbSet.zpp_pool.next = null;
            ZPP_Set_ZPP_CbSet.zpp_pool = _loc81_;
         }
         while(ZPP_SensorArbiter.zpp_pool != null)
         {
            _loc82_ = ZPP_SensorArbiter.zpp_pool.next;
            ZPP_SensorArbiter.zpp_pool.next = null;
            ZPP_SensorArbiter.zpp_pool = _loc82_;
         }
         while(ZPP_FluidArbiter.zpp_pool != null)
         {
            _loc83_ = ZPP_FluidArbiter.zpp_pool.next;
            ZPP_FluidArbiter.zpp_pool.next = null;
            ZPP_FluidArbiter.zpp_pool = _loc83_;
         }
         while(ZNPNode_ZPP_FluidArbiter.zpp_pool != null)
         {
            _loc84_ = ZNPNode_ZPP_FluidArbiter.zpp_pool.next;
            ZNPNode_ZPP_FluidArbiter.zpp_pool.next = null;
            ZNPNode_ZPP_FluidArbiter.zpp_pool = _loc84_;
         }
         while(ZNPNode_ZPP_SensorArbiter.zpp_pool != null)
         {
            _loc85_ = ZNPNode_ZPP_SensorArbiter.zpp_pool.next;
            ZNPNode_ZPP_SensorArbiter.zpp_pool.next = null;
            ZNPNode_ZPP_SensorArbiter.zpp_pool = _loc85_;
         }
         while(ZNPNode_ZPP_Listener.zpp_pool != null)
         {
            _loc86_ = ZNPNode_ZPP_Listener.zpp_pool.next;
            ZNPNode_ZPP_Listener.zpp_pool.next = null;
            ZNPNode_ZPP_Listener.zpp_pool = _loc86_;
         }
         while(ZPP_ColArbiter.zpp_pool != null)
         {
            _loc87_ = ZPP_ColArbiter.zpp_pool.next;
            ZPP_ColArbiter.zpp_pool.next = null;
            ZPP_ColArbiter.zpp_pool = _loc87_;
         }
         while(ZNPNode_ZPP_ColArbiter.zpp_pool != null)
         {
            _loc88_ = ZNPNode_ZPP_ColArbiter.zpp_pool.next;
            ZNPNode_ZPP_ColArbiter.zpp_pool.next = null;
            ZNPNode_ZPP_ColArbiter.zpp_pool = _loc88_;
         }
         while(ZNPNode_ZPP_ToiEvent.zpp_pool != null)
         {
            _loc89_ = ZNPNode_ZPP_ToiEvent.zpp_pool.next;
            ZNPNode_ZPP_ToiEvent.zpp_pool.next = null;
            ZNPNode_ZPP_ToiEvent.zpp_pool = _loc89_;
         }
         while(ZNPNode_ZPP_InteractionGroup.zpp_pool != null)
         {
            _loc90_ = ZNPNode_ZPP_InteractionGroup.zpp_pool.next;
            ZNPNode_ZPP_InteractionGroup.zpp_pool.next = null;
            ZNPNode_ZPP_InteractionGroup.zpp_pool = _loc90_;
         }
         while(ZPP_InteractionFilter.zpp_pool != null)
         {
            _loc91_ = ZPP_InteractionFilter.zpp_pool.next;
            ZPP_InteractionFilter.zpp_pool.next = null;
            ZPP_InteractionFilter.zpp_pool = _loc91_;
         }
      ...
      {
         // method body index: 1664 method index: 1683
         ...
         while(true)
         {
            ...
            var _temp_5:* = _loc9_.zpp_inner;
            _loc9_.zpp_i = (_loc12_ = _loc9_.zpp_i) + 1;
            _loc11_ = _temp_5.at(_loc12_);
      ...
      {
         // method body index: 1666 method index: 1664
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 1667 method index: 1665
         if(zpp_inner.isbmp)
         {
      ...
      {
         // method body index: 1668 method index: 1666
         if(zpp_inner.xform == null)
         {
            zpp_inner.setform();
         }
      ...
      {
         // method body index: 1669 method index: 1667
