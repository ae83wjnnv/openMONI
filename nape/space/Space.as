package nape.space
{
   ...
   public final class Space
   {
      ...
      {
         // method body index: 2170 method index: 2134
      ...
      {
         // method body index: 2130 method index: 2136
         ...
         while(true)
         {
            ...
            var _temp_6:* = _loc6_.zpp_inner;
            _loc6_.zpp_i = (_loc5_ = _loc6_.zpp_i) + 1;
            _loc8_ = _temp_6.at(_loc5_);
      ...
      {
         // method body index: 2131 method index: 2137
      ...
      {
         // method body index: 2132 method index: 2138
      ...
      {
         // method body index: 2133 method index: 2139
         if(param1 != param1)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 2134 method index: 2140
         var _loc5_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 2135 method index: 2141
      ...
      {
         // method body index: 2136 method index: 2142
         var _loc7_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 2137 method index: 2143
         ...
         while(true)
         {
            ...
            var _temp_4:* = _loc5_.zpp_inner;
            _loc5_.zpp_i = (_loc8_ = _loc5_.zpp_i) + 1;
            _loc7_ = _temp_4.at(_loc8_);
      ...
      {
         // method body index: 2138 method index: 2144
         ...
         §§push(true);
         if((_loc6_ = param1.zpp_inner)._validate != null)
         {
            _loc6_._validate();
         }
      ...
      {
         // method body index: 2139 method index: 2145
      ...
      {
         // method body index: 2140 method index: 2146
         var _loc2_:Number = param1;
         if(_loc2_ != _loc2_)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 2141 method index: 2147
      ...
      {
         // method body index: 2142 method index: 2148
         var _loc3_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 2143 method index: 2149
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 2144 method index: 2150
         if(param1 == null)
         {
            Boot.lastError = new Error();
            throw "Error: Cannot cast null ray :)";
      ...
      {
         // method body index: 2145 method index: 2151
         ...
         if(!_loc7_ && !§§pop())
         {
            if((_loc3_.sensorEnabled || _loc4_.sensorEnabled) && ((_loc14_.sensorMask & _loc15_.sensorGroup) != 0 && (_loc15_.sensorMask & _loc14_.sensorGroup) != 0))
            {
               §§push(2);
            }
            else if((_loc3_.fluidEnabled || _loc4_.fluidEnabled) && ((_loc14_.fluidMask & _loc15_.fluidGroup) != 0 && (_loc15_.fluidMask & _loc14_.fluidGroup) != 0) && !(_loc5_.imass == 0 && _loc6_.imass == 0 && _loc5_.iinertia == 0 && _loc6_.iinertia == 0))
            {
               §§push(0);
            }
            else
            {
               ...
               if((_loc14_.collisionMask & _loc15_.collisionGroup) != 0 && (_loc15_.collisionMask & _loc14_.collisionGroup) != 0)
               {
                  §§pop();
                  §§push(!(_loc5_.imass == 0 && _loc6_.imass == 0 && _loc5_.iinertia == 0 && _loc6_.iinertia == 0));
               }
               §§push(§§pop() ? 1 : -1);
            }
         }
      ...
      {
         // method body index: 2146 method index: 2152
         return zpp_inner.global_lin_drag;
      }
      
      public function get worldAngularDrag() : Number
      {
         // method body index: 2147 method index: 2153
         return zpp_inner.global_ang_drag;
      }
      
      public function get world() : Body
      {
         // method body index: 2148 method index: 2154
         return zpp_inner.__static;
      }
      
      public function get userData() : *
      {
         // method body index: 2149 method index: 2155
      ...
      {
         // method body index: 2160 method index: 2166
         return zpp_inner.wrap_bodies;
      }
      
      public function get arbiters() : ArbiterList
      {
         // method body index: 2161 method index: 2167
      ...
      {
         // method body index: 2162 method index: 2168
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 2163 method index: 2169
         if(param1 == null)
         {
            Boot.lastError = new Error();
            throw "Error: Cannot cast null shape :)";
      ...
      {
         // method body index: 2164 method index: 2170
      ...
      {
         // method body index: 2165 method index: 2171
         var _loc5_:* = null as ZPP_Vec2;
         var _loc6_:* = null as Vec2;
         var _loc7_:* = null as ZPP_Vec2;
         if(param1 != null && param1.zpp_disp)
      ...
      {
         // method body index: 2166 method index: 2172
         var _loc5_:* = null as ValidationResult;
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 2167 method index: 2173
         var _loc7_:* = null as ZPP_Vec2;
         var _loc8_:* = null as Vec2;
         var _loc9_:* = null as ZPP_Vec2;
         if(param1 != null && param1.zpp_disp)
      ...
      {
         // method body index: 2168 method index: 2174
         var _loc6_:* = null as ShapeList;
         var _loc7_:* = null as Shape;
         var _loc8_:int = 0;
      ...
      {
         // method body index: 2169 method index: 2175
         var _loc6_:* = null as ZPP_AABB;
         if(param1 == null)
         {
            Boot.lastError = new Error();
