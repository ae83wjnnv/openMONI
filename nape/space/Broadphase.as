package nape.space
{
   ...
   public final class Broadphase
   {
      ...
      {
         // method body index: 4365 method index: 4724
      ...
      {
         // method body index: 4361 method index: 4727
      ...
      {
         // method body index: 4362 method index: 4728
      ...
      {
         // method body index: 4364 method index: 4726
         §§push(this);
         if(ZPP_Flags.Broadphase_DYNAMIC_AABB_TREE == null)
         {
            ZPP_Flags.§internal§ = true;
