package nape.shape
{
   ...
   public final class Polygon extends Shape
   {
      ...
      {
         // method body index: 3589 method index: 3860
         var _loc5_:* = null;
         ...
         catch(_loc_e_:*)
         {
            ...
            else if(param1 is Vec2List)
            {
               ...
               while(true)
               {
                  ...
                  var _temp_15:* = _loc18_.zpp_inner;
                  _loc18_.zpp_i = (_loc7_ = _loc18_.zpp_i) + 1;
                  _loc8_ = _temp_15.at(_loc7_);
                  if(_loc8_ == null)
                  {
                     Boot.lastError = new Error();
      ...
      {
         // method body index: 3581 method index: 3867
      ...
      {
         // method body index: 3582 method index: 3868
         if(param1 != param1 || param2 != param2)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 3583 method index: 3869
         var _loc9_:int = 0;
         var _loc10_:Number = NaN;
      ...
      {
         // method body index: 3585 method index: 3862
         return zpp_inner_zn.valid();
      }
      
      public function get worldVerts() : Vec2List
      {
         // method body index: 3586 method index: 3863
      ...
      {
         // method body index: 3587 method index: 3864
         if(zpp_inner_zn.wrap_lverts == null)
         {
            zpp_inner_zn.getlverts();
         }
      ...
      {
         // method body index: 3588 method index: 3865
