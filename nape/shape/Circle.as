package nape.shape
{
   ...
   public final class Circle extends Shape
   {
      ...
      {
         // method body index: 2916 method index: 2986
         var _loc6_:* = null;
         ...
         catch(_loc_e_:*)
         {
            ...
            if(param1 != zpp_inner_zn.radius)
            {
               ...
               {
                  Boot.lastError = new Error();
                  throw "Error: Circle::radius (" + param1 + ") must be > PR(Const).EPSILON";
               }
               if(param1 > 1e+100)
               {
                  Boot.lastError = new Error();
      ...
      {
         // method body index: 2914 method index: 2988
         zpp_inner.immutable_midstep("Circle::radius");
         if(zpp_inner.body != null && zpp_inner.body.type == ZPP_Flags.id_BodyType_STATIC && zpp_inner.body.space != null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 2915 method index: 2989
         return zpp_inner_zn.radius;
      }
   }
}
