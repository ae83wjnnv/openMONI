package nape.shape
{
   ...
   public final class EdgeList
   {
      ...
      {
         // method body index: 5871 method index: 6314
      ...
      {
         // method body index: 5851 method index: 6333
      ...
      {
         // method body index: 5852 method index: 6334
         var _loc4_:* = null as Edge;
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 5854 method index: 6316
      ...
      {
         // method body index: 5855 method index: 6317
         var _loc4_:* = null as Edge;
         var _loc5_:int = 0;
      ...
      {
         // method body index: 5856 method index: 6318
      ...
      {
         // method body index: 5857 method index: 6319
      ...
      {
         // method body index: 5858 method index: 6320
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Edge" + "List is immutable";
      ...
      {
         // method body index: 5859 method index: 6321
      ...
      {
         // method body index: 5860 method index: 6322
         var _loc3_:* = null as Edge;
         var _loc4_:int = 0;
      ...
      {
         // method body index: 5861 method index: 6323
         zpp_inner.valmod();
      ...
      {
         // method body index: 5862 method index: 6324
         zpp_inner.valmod();
      ...
      {
         // method body index: 5863 method index: 6325
         zpp_inner.valmod();
         if(zpp_inner.zip_length)
         {
            zpp_inner.zip_length = false;
      ...
      {
         // method body index: 5864 method index: 6326
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc6_:* = null as EdgeList;
         if(param1 == null)
      ...
      {
         // method body index: 5865 method index: 6327
         var _loc4_:* = null as Edge;
         var _loc5_:* = null;
         if(param1 == null)
         {
      ...
      {
         // method body index: 5868 method index: 6330
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Edge" + "List is immutable";
      ...
      {
         // method body index: 5869 method index: 6331
         zpp_inner.valmod();
      ...
      {
         // method body index: 5870 method index: 6332
