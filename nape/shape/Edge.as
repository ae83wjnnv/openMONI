package nape.shape
{
   ...
   public final class Edge
   {
      ...
      {
         // method body index: 5486 method index: 5898
      ...
      {
         // method body index: 5475 method index: 5900
      ...
      {
         // method body index: 5476 method index: 5901
         var _loc2_:* = null as ZPP_Body;
         var _loc3_:* = null as ZPP_Vec2;
         var _loc4_:* = null as ZPP_Vec2;
         var _loc5_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 5477 method index: 5902
         var _loc2_:* = null as ZPP_Body;
         var _loc3_:* = null as ZPP_Vec2;
         var _loc4_:* = null as ZPP_Vec2;
         var _loc5_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 5478 method index: 5903
         var _loc2_:* = null as ZPP_Body;
         var _loc3_:* = null as ZPP_Vec2;
         var _loc4_:* = null as ZPP_Vec2;
         var _loc5_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 5479 method index: 5904
         if(zpp_inner.polygon == null)
         {
            Boot.lastError = new Error();
            throw "Error: Edge not current in use";
      ...
      {
         // method body index: 5480 method index: 5905
         if(zpp_inner.polygon == null)
         {
            Boot.lastError = new Error();
            throw "Error: Edge not current in use";
      ...
      {
         // method body index: 5481 method index: 5906
      ...
      {
         // method body index: 5482 method index: 5907
         var _loc2_:* = null as ZPP_Vec2;
         if(zpp_inner.polygon == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 5483 method index: 5908
         if(zpp_inner.polygon == null)
         {
            Boot.lastError = new Error();
            throw "Error: Edge not current in use";
      ...
      {
         // method body index: 5484 method index: 5909
         if(zpp_inner.polygon == null)
         {
            Boot.lastError = new Error();
            throw "Error: Edge not current in use";
      ...
      {
         // method body index: 5485 method index: 5910
         if(zpp_inner.polygon == null)
         {
            Boot.lastError = new Error();
            throw "Error: Edge not current in use";
