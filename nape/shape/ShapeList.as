package nape.shape
{
   ...
   public final class ShapeList
   {
      ...
      {
         // method body index: 1996 method index: 1979
      ...
      {
         // method body index: 1976 method index: 1998
      ...
      {
         // method body index: 1977 method index: 1999
         var _loc4_:* = null as Shape;
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 1979 method index: 1981
      ...
      {
         // method body index: 1980 method index: 1982
         var _loc4_:* = null as Shape;
         var _loc5_:int = 0;
      ...
      {
         // method body index: 1981 method index: 1983
      ...
      {
         // method body index: 1982 method index: 1984
      ...
      {
         // method body index: 1983 method index: 1985
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Shape" + "List is immutable";
      ...
      {
         // method body index: 1984 method index: 1986
      ...
      {
         // method body index: 1985 method index: 1987
         var _loc3_:* = null as Shape;
         var _loc4_:int = 0;
      ...
      {
         // method body index: 1986 method index: 1988
         zpp_inner.valmod();
      ...
      {
         // method body index: 1987 method index: 1989
         zpp_inner.valmod();
      ...
      {
         // method body index: 1988 method index: 1990
         zpp_inner.valmod();
         if(zpp_inner.zip_length)
         {
            zpp_inner.zip_length = false;
      ...
      {
         // method body index: 1989 method index: 1991
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc6_:* = null as ShapeList;
         if(param1 == null)
      ...
      {
         // method body index: 1990 method index: 1992
         var _loc4_:* = null as Shape;
         var _loc5_:* = null;
         if(param1 == null)
         {
      ...
      {
         // method body index: 1993 method index: 1995
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Shape" + "List is immutable";
      ...
      {
         // method body index: 1994 method index: 1996
         zpp_inner.valmod();
      ...
      {
         // method body index: 1995 method index: 1997
