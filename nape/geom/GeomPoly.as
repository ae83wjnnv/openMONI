package nape.geom
{
   ...
   public final class GeomPoly
   {
      ...
      {
         // method body index: 3302 method index: 3468
         ...
         if(param1 != null)
         {
            ...
            else if(param1 is Vec2List)
            {
               ...
               while(true)
               {
                  ...
                  var _temp_20:* = _loc12_.zpp_inner;
                  _loc12_.zpp_i = (_loc3_ = _loc12_.zpp_i) + 1;
                  _loc5_ = _temp_20.at(_loc3_);
                  if(_loc5_ == null)
                  {
                     Boot.lastError = new Error();
      ...
      {
         // method body index: 3262 method index: 3508
         ...
         if(param1 != null)
         {
            ...
            else if(param1 is Vec2List)
            {
               ...
               while(true)
               {
                  ...
                  var _temp_20:* = _loc13_.zpp_inner;
                  _loc13_.zpp_i = (_loc4_ = _loc13_.zpp_i) + 1;
                  _loc6_ = _temp_20.at(_loc4_);
                  if(_loc6_ == null)
                  {
                     Boot.lastError = new Error();
                     throw "Error: Vec2List contains null objects";
      ...
      {
         // method body index: 3264 method index: 3470
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc5_ = _loc5_.next, _loc5_ != _loc4_);
         }
         _loc1_ = _loc2_ * 0.5;
         if(_loc1_ > 0)
         {
      ...
      {
         // method body index: 3265 method index: 3471
         var _loc3_:* = null as ZPP_GeomVert;
      ...
      {
         // method body index: 3266 method index: 3472
      ...
      {
         // method body index: 3267 method index: 3473
         var _loc4_:* = null as ZPP_GeomVert;
         var _loc5_:* = null as ZPP_GeomVert;
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc4_ = _loc4_.next, _loc4_ != _loc3_);
         }
         return this;
      }
      ...
      {
         // method body index: 3268 method index: 3474
         var _loc4_:* = null as ZPP_GeomVert;
         var _loc5_:* = null as ZPP_GeomVert;
         var _loc6_:Number = NaN;
      ...
      {
         // method body index: 3269 method index: 3475
         var _loc4_:* = null as ZPP_GeomVert;
         var _loc5_:* = null as ZPP_GeomVert;
      ...
      {
         // method body index: 3270 method index: 3476
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "GeomPoly" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3271 method index: 3477
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "GeomPoly" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3272 method index: 3478
         var _loc4_:* = null as ZPP_GeomVert;
         var _loc5_:* = null as ZPP_GeomVert;
         if(zpp_disp)
         {
      ...
      {
         // method body index: 3273 method index: 3479
      ...
      {
         // method body index: 3274 method index: 3480
         var _loc4_:* = null as ZPP_GeomVert;
      ...
      {
         // method body index: 3275 method index: 3481
         var _loc2_:* = null as ZPP_GeomVert;
         var _loc3_:* = null as ZPP_GeomVert;
      ...
      {
         // method body index: 3276 method index: 3482
         var _loc4_:* = null as ZPP_GeomVert;
         var _loc5_:* = null as ZPP_GeomVert;
         var _loc6_:Number = NaN;
         var _loc7_:Number = NaN;
      ...
      {
         // method body index: 3277 method index: 3483
         var _loc3_:* = null as ZPP_GeomVert;
         var _loc4_:* = null as ZPP_Vec2;
         var _loc5_:* = null as Vec2;
         var _loc6_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 3278 method index: 3484
         var _loc2_:* = null as ZPP_GeomVert;
         var _loc3_:* = null as ZPP_GeomVert;
         var _loc4_:* = null as Vec2;
         var _loc5_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 3279 method index: 3485
         var _loc5_:* = null as ZPP_GeomVert;
      ...
      {
         // method body index: 3280 method index: 3486
         var _loc4_:* = null as ZPP_GeomVert;
         var _loc5_:* = null as ZPP_GeomVert;
         var _loc6_:Number = NaN;
         var _loc7_:Number = NaN;
      ...
      {
         // method body index: 3281 method index: 3487
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "GeomPoly" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3282 method index: 3488
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "GeomPoly" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3283 method index: 3489
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "GeomPoly" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3284 method index: 3490
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "GeomPoly" + " has been disposed and cannot be used!";
         }
         return zpp_inner.vertices == null || zpp_inner.vertices.next == null || zpp_inner.vertices.prev == zpp_inner.vertices.next ? true : area() < 1e-8;
      }
      
      public function isConvex() : Boolean
      {
         // method body index: 3285 method index: 3491
         ...
         else
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc6_ = _loc6_.next, _loc6_ != _loc5_);
            }
            return _loc3_;
         }
      }
      ...
      {
         // method body index: 3286 method index: 3492
         §§push(winding());
         if(ZPP_Flags.Winding_CLOCKWISE == null)
         {
            ZPP_Flags.§internal§ = true;
      ...
      {
         // method body index: 3287 method index: 3493
         var _loc5_:* = null as ZPP_GeomVert;
         var _loc6_:* = null as ZPP_GeomVert;
         var _loc7_:* = null as ZPP_GeomVert;
         var _loc8_:* = null as ZPP_GeomVert;
         ...
         if(_loc3_ != null)
         {
            ...
            while(true)
            {
               ...
               _loc19_ = lf32(0);
               _loc19_ = _loc18_ = _loc19_ * (1.5 - 0.5 * _loc17_ * _loc19_ * _loc19_);
               _loc13_ *= _loc19_;
               _loc14_ *= _loc19_;
               _loc17_ = _loc13_;
               _loc13_ = -_loc14_;
      ...
      {
         // method body index: 3288 method index: 3494
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "GeomPoly" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3289 method index: 3495
         var _loc2_:* = null as ZPP_GeomVert;
         var _loc3_:* = null as ZPP_GeomVert;
         var _loc4_:* = null as ZPP_GeomVert;
         var _loc5_:* = null as Vec2;
      ...
      {
         // method body index: 3290 method index: 3496
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "GeomPoly" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3291 method index: 3497
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "GeomPoly" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3292 method index: 3498
         var _loc7_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 3293 method index: 3499
         var _loc2_:Number = NaN;
      ...
      {
         // method body index: 3294 method index: 3500
         var _loc4_:* = null as ZPP_GeomVert;
         var _loc5_:* = null as ZPP_GeomVert;
         var _loc6_:* = null as ZPP_GeomVert;
         var _loc7_:* = null as ZPP_GeomVert;
      ...
      {
         // method body index: 3295 method index: 3501
         var _loc6_:* = null as ZPP_PartitionedPoly;
         var _loc7_:* = null as ZNPList_ZPP_GeomVert;
         var _loc8_:* = null as ZPP_PartitionedPoly;
         var _loc9_:* = null as ZPP_GeomVert;
      ...
      {
         // method body index: 3296 method index: 3502
         var _loc4_:* = null as ZPP_Vec2;
         var _loc9_:* = null as ZPP_GeomVert;
         ...
         if(_loc7_ != null)
         {
            ...
            while(_loc9_ = _loc9_.next, _loc9_ != _loc8_);
         }
      ...
      {
         // method body index: 3297 method index: 3503
      ...
      {
         // method body index: 3298 method index: 3504
         var _loc7_:* = null as ZPP_GeomVert;
         var _loc8_:* = null as ZPP_GeomVert;
         if(zpp_disp)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc7_ = _loc7_.next, _loc7_ != _loc6_);
         }
      ...
      {
         // method body index: 3299 method index: 3505
         var _loc4_:* = null as ZPP_GeomVert;
         var _loc5_:* = null as ZPP_GeomVert;
         var _loc6_:Number = NaN;
         var _loc7_:Number = NaN;
      ...
      {
         // method body index: 3300 method index: 3506
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "GeomPoly" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3301 method index: 3507
         var _loc1_:Number = NaN;
         var _loc2_:Number = NaN;
         var _loc3_:* = null as ZPP_GeomVert;
         var _loc4_:* = null as ZPP_GeomVert;
