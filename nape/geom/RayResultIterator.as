package nape.geom
{
   ...
   public final class RayResultIterator
   {
      ...
      // method body index: 3257 method index: 3463
      public static var zpp_pool:RayResultIterator = // method body index: 3261 method index: 3467
      null;
      ...
      {
         // method body index: 3260 method index: 3462
      ...
      {
         // method body index: 3256 method index: 3466
      ...
      {
         // method body index: 3258 method index: 3464
         zpp_critical = false;
      ...
      {
         // method body index: 3259 method index: 3465
