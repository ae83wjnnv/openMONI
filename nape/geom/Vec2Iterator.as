package nape.geom
{
   ...
   public final class Vec2Iterator
   {
      ...
      // method body index: 3391 method index: 3627
      public static var zpp_pool:Vec2Iterator = // method body index: 3395 method index: 3631
      null;
      ...
      {
         // method body index: 3394 method index: 3626
      ...
      {
         // method body index: 3390 method index: 3630
      ...
      {
         // method body index: 3392 method index: 3628
         zpp_critical = false;
      ...
      {
         // method body index: 3393 method index: 3629
