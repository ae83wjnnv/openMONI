package nape.geom
{
   ...
   public final class Vec3
   {
      ...
      {
         // method body index: 3456 method index: 3692
      ...
      {
         // method body index: 3440 method index: 3708
      ...
      {
         // method body index: 3442 method index: 3694
      ...
      {
         // method body index: 3443 method index: 3695
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3444 method index: 3696
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3445 method index: 3697
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3446 method index: 3698
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3447 method index: 3699
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3448 method index: 3700
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3449 method index: 3701
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3450 method index: 3702
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3451 method index: 3703
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3452 method index: 3704
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3453 method index: 3705
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3454 method index: 3706
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 3455 method index: 3707
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec3" + " has been disposed and cannot be used!";
