package nape.geom
{
   ...
   public final class Vec2
   {
      ...
      {
         // method body index: 1974 method index: 1941
      ...
      {
         // method body index: 1938 method index: 1972
      ...
      {
         // method body index: 1939 method index: 1973
      ...
      {
         // method body index: 1940 method index: 1974
      ...
      {
         // method body index: 1941 method index: 1975
      ...
      {
         // method body index: 1942 method index: 1976
         var _loc6_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 1943 method index: 1977
         var _loc6_:* = null as ZPP_Vec2;
         var _loc7_:* = null as Vec2;
         var _loc8_:* = null as ZPP_Vec2;
         if(param1 != null && param1.zpp_disp)
      ...
      {
         // method body index: 1945 method index: 1943
         ...
         var _temp_3:*;
         var _loc3_:Number = §§pop() / (_loc4_ == 0 ? 0 : (_temp_3 = 1,sf32(_loc4_,0),si32(1597463007 - (li32(0) >> 1),0),_temp_3 / (_loc5_ * (1.5 - 0.5 * _loc4_ * _loc5_ * _loc5_))));
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 1946 method index: 1944
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 1947 method index: 1945
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 1948 method index: 1946
         var _loc2_:* = null as ZPP_Vec2;
         var _loc5_:* = null as Vec2;
         var _loc6_:* = null as ZPP_Vec2;
         if(zpp_disp)
      ...
      {
         // method body index: 1949 method index: 1947
         var _loc5_:* = null as ZPP_Vec2;
         var _loc7_:* = null as Vec2;
      ...
      {
         // method body index: 1950 method index: 1948
      ...
      {
         // method body index: 1951 method index: 1949
         var _loc2_:* = null as ZPP_Vec2;
         if(zpp_disp)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 1952 method index: 1950
         var _loc2_:* = null as ZPP_Vec2;
         if(zpp_disp)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 1953 method index: 1951
         var _loc2_:* = null as ZPP_Vec2;
         if(zpp_disp)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 1954 method index: 1952
         var _loc2_:* = null as ZPP_Vec2;
         if(zpp_disp)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 1955 method index: 1953
         var _loc2_:* = null as ZPP_Vec2;
         var _loc6_:* = null as Vec2;
         var _loc7_:* = null as ZPP_Vec2;
         if(zpp_disp)
      ...
      {
         // method body index: 1956 method index: 1954
         var _loc2_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 1957 method index: 1955
         var _loc3_:* = null as ZPP_Vec2;
         var _loc7_:* = null as Vec2;
         var _loc8_:Boolean = false;
      ...
      {
         // method body index: 1958 method index: 1956
         var _loc3_:* = null as ZPP_Vec2;
         var _loc5_:* = null as Vec2;
         var _loc6_:Boolean = false;
         if(zpp_disp)
      ...
      {
         // method body index: 1959 method index: 1957
      ...
      {
         // method body index: 1960 method index: 1958
         var _loc2_:* = null as ZPP_Vec2;
         if(zpp_disp)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 1961 method index: 1959
         var _loc4_:* = null as ZPP_Vec2;
         var _loc6_:* = null as Vec2;
         var _loc7_:Boolean = false;
         if(zpp_disp)
      ...
      {
         // method body index: 1962 method index: 1960
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 1963 method index: 1961
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 1964 method index: 1962
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 1965 method index: 1963
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 1966 method index: 1964
         var _loc1_:* = null as ZPP_Vec2;
         if(zpp_disp)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 1967 method index: 1965
         var _loc3_:* = null as ZPP_Vec2;
         var _loc4_:* = null as Vec2;
         var _loc5_:* = null as ZPP_Vec2;
         if(zpp_disp)
      ...
      {
         // method body index: 1968 method index: 1966
         if(zpp_disp)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Vec2" + " has been disposed and cannot be used!";
      ...
      {
         // method body index: 1969 method index: 1967
         var _loc3_:* = null as ZPP_Vec2;
         var _loc4_:* = null as Vec2;
         var _loc5_:* = null as ZPP_Vec2;
         if(zpp_disp)
      ...
      {
         // method body index: 1970 method index: 1968
         var _loc3_:* = null as ZPP_Vec2;
         var _loc5_:* = null as Vec2;
         var _loc6_:Boolean = false;
         if(zpp_disp)
      ...
      {
         // method body index: 1971 method index: 1969
         var _loc2_:* = null as ZPP_Vec2;
         var _loc5_:* = null as Vec2;
         var _loc6_:* = null as ZPP_Vec2;
         if(zpp_disp)
      ...
      {
         // method body index: 1972 method index: 1970
         var _loc6_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 1973 method index: 1971
         var _loc5_:* = null as ZPP_Vec2;
         var _loc7_:* = null as Vec2;
         var _loc8_:Boolean = false;
         var _loc9_:* = null as ZPP_Vec2;
