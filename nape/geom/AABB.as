package nape.geom
{
   ...
   public final class AABB
   {
      ...
      {
         // method body index: 2245 method index: 2233
      ...
      {
         // method body index: 2228 method index: 2250
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 2230 method index: 2235
      ...
      {
         // method body index: 2231 method index: 2236
      ...
      {
         // method body index: 2232 method index: 2237
         ...
         if(zpp_inner.miny != param1)
         {
            ...
            _temp_1.maxy += param1 - zpp_inner.miny;
      ...
      {
         // method body index: 2233 method index: 2238
         var _loc2_:* = null as ZPP_AABB;
         if(zpp_inner._immutable)
         {
            Boot.lastError = new Error();
         ...
         if(zpp_inner.minx != param1)
         {
            ...
            _temp_1.maxx += param1 - zpp_inner.minx;
      ...
      {
         // method body index: 2234 method index: 2239
         var _loc2_:* = null as ZPP_AABB;
         if(zpp_inner._immutable)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 2235 method index: 2240
         var _loc2_:* = null as ZPP_AABB;
      ...
      {
         // method body index: 2236 method index: 2241
         var _loc2_:* = null as ZPP_AABB;
         var _loc3_:* = null as ZPP_Vec2;
         var _loc8_:* = null as Vec2;
         var _loc9_:* = null as ZPP_Vec2;
      ...
      {
         // method body index: 2237 method index: 2242
         var _loc2_:* = null as ZPP_AABB;
         if(zpp_inner._immutable)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 2238 method index: 2243
         var _loc1_:ZPP_AABB = zpp_inner;
         if(_loc1_._validate != null)
         {
            _loc1_._validate();
      ...
      {
         // method body index: 2239 method index: 2244
         var _loc1_:ZPP_AABB = zpp_inner;
         if(_loc1_._validate != null)
         {
            _loc1_._validate();
      ...
      {
         // method body index: 2240 method index: 2245
         var _loc1_:ZPP_AABB = zpp_inner;
         if(_loc1_._validate != null)
         {
            _loc1_._validate();
      ...
      {
         // method body index: 2241 method index: 2246
         return zpp_inner.getmin();
      }
      
      public function get max() : Vec2
      {
         // method body index: 2242 method index: 2247
         return zpp_inner.getmax();
      }
      
      public function get height() : Number
      {
         // method body index: 2243 method index: 2248
         var _loc1_:ZPP_AABB = zpp_inner;
         if(_loc1_._validate != null)
         {
            _loc1_._validate();
      ...
      {
         // method body index: 2244 method index: 2249
         var _loc2_:* = null as ZPP_AABB;
         var _loc1_:ZPP_AABB = zpp_inner;
         if(_loc1_._validate != null)
         {
