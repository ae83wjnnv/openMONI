package nape.geom
{
   ...
   public final class GeomPolyList
   {
      ...
      {
         // method body index: 5817 method index: 6260
      ...
      {
         // method body index: 5797 method index: 6279
      ...
      {
         // method body index: 5798 method index: 6280
         var _loc4_:* = null as GeomPoly;
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 5800 method index: 6262
      ...
      {
         // method body index: 5801 method index: 6263
         var _loc4_:* = null as GeomPoly;
         var _loc5_:int = 0;
      ...
      {
         // method body index: 5802 method index: 6264
      ...
      {
         // method body index: 5803 method index: 6265
      ...
      {
         // method body index: 5804 method index: 6266
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "GeomPoly" + "List is immutable";
      ...
      {
         // method body index: 5805 method index: 6267
      ...
      {
         // method body index: 5806 method index: 6268
         var _loc3_:* = null as GeomPoly;
         var _loc4_:int = 0;
      ...
      {
         // method body index: 5807 method index: 6269
         zpp_inner.valmod();
      ...
      {
         // method body index: 5808 method index: 6270
         zpp_inner.valmod();
      ...
      {
         // method body index: 5809 method index: 6271
         zpp_inner.valmod();
         if(zpp_inner.zip_length)
         {
            zpp_inner.zip_length = false;
      ...
      {
         // method body index: 5810 method index: 6272
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc6_:* = null as GeomPolyList;
         if(param1 == null)
      ...
      {
         // method body index: 5811 method index: 6273
         var _loc4_:* = null as GeomPoly;
         var _loc5_:* = null;
         if(param1 == null)
         {
      ...
      {
         // method body index: 5814 method index: 6276
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "GeomPoly" + "List is immutable";
      ...
      {
         // method body index: 5815 method index: 6277
         zpp_inner.valmod();
      ...
      {
         // method body index: 5816 method index: 6278
