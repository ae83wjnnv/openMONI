package nape.geom
{
   ...
   public final class MatMN
   {
      ...
      {
         // method body index: 5962 method index: 6419
      ...
      {
         // method body index: 5955 method index: 6421
      ...
      {
         // method body index: 5956 method index: 6422
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc7_:int = 0;
      ...
      {
         // method body index: 5957 method index: 6423
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc8_:int = 0;
      ...
      {
         // method body index: 5958 method index: 6424
         if(param1 < 0 || param2 < 0 || param1 >= zpp_inner.m || param2 >= zpp_inner.n)
         {
            Boot.lastError = new Error();
            throw "Error: MatMN indices out of range";
      ...
      {
         // method body index: 5959 method index: 6425
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:int = 0;
      ...
      {
         // method body index: 5960 method index: 6426
         return zpp_inner.m;
      }
      
      public function get cols() : int
      {
         // method body index: 5961 method index: 6427
         return zpp_inner.n;
      }
   }
}
