package nape.callbacks
{
   ...
   public final class OptionType
   {
      ...
      {
         // method body index: 5948 method index: 6406
      ...
      {
         // method body index: 5943 method index: 6408
      ...
      {
         // method body index: 5944 method index: 6409
      ...
      {
         // method body index: 5945 method index: 6410
         if(zpp_inner.wrap_includes == null)
         {
            zpp_inner.setup_includes();
         }
      ...
      {
         // method body index: 5946 method index: 6411
         if(zpp_inner.wrap_excludes == null)
         {
            zpp_inner.setup_excludes();
         }
      ...
      {
         // method body index: 5947 method index: 6413
