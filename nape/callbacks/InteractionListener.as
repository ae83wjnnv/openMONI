package nape.callbacks
{
   ...
   public final class InteractionListener extends Listener
   {
      ...
      {
         // method body index: 6548 method index: 7082
         var _loc8_:int = 0;
      ...
      {
         // method body index: 6538 method index: 7084
      ...
      {
         // method body index: 6539 method index: 7085
      ...
      {
         // method body index: 6540 method index: 7086
         var _loc2_:int = 0;
         if(param1 == null)
         {
            Boot.lastError = new Error();
      ...
      {
         // method body index: 6541 method index: 7087
         if(param1 == null)
         {
            Boot.lastError = new Error();
            throw "Error: InteractionListener::handler cannot be null";
      ...
      {
         // method body index: 6542 method index: 7088
      ...
      {
         // method body index: 6543 method index: 7089
         return zpp_inner_zn.options2.outer;
      }
      
      public function get options1() : OptionType
      {
         // method body index: 6544 method index: 7090
         return zpp_inner_zn.options1.outer;
      }
      
      public function get interactionType() : InteractionType
      {
         // method body index: 6545 method index: 7091
      ...
      {
         // method body index: 6546 method index: 7092
         return zpp_inner_zn.handleri;
      }
      
      public function get allowSleepingCallbacks() : Boolean
      {
         // method body index: 6547 method index: 7093
         return zpp_inner_zn.allowSleepingCallbacks;
      }
   }
}
