package nape.callbacks
{
   ...
   public final class PreFlag
   {
      ...
      {
         // method body index: 5558 method index: 5976
      ...
      {
         // method body index: 5552 method index: 5979
      ...
      {
         // method body index: 5553 method index: 5980
      ...
      {
         // method body index: 5554 method index: 5981
      ...
      {
         // method body index: 5555 method index: 5982
      ...
      {
         // method body index: 5557 method index: 5978
         §§push(this);
         if(ZPP_Flags.PreFlag_ACCEPT == null)
         {
            ZPP_Flags.§internal§ = true;
