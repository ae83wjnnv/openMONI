package nape.callbacks
{
   ...
   public class Callback
   {
      ...
      {
         // method body index: 5923 method index: 6383
      ...
      {
         // method body index: 5920 method index: 6385
         return "";
      }
      
      public function get listener() : Listener
      {
         // method body index: 5921 method index: 6386
         return zpp_inner.listener.outer;
      }
      
      public function get event() : CbEvent
      {
         // method body index: 5922 method index: 6387
