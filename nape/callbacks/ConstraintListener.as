package nape.callbacks
{
   ...
   public final class ConstraintListener extends Listener
   {
      ...
      {
         // method body index: 6614 method index: 7163
      ...
      {
         // method body index: 6610 method index: 7165
      ...
      {
         // method body index: 6611 method index: 7166
         if(param1 == null)
         {
            Boot.lastError = new Error();
            throw "Error: ConstraintListener::handler cannot be null";
      ...
      {
         // method body index: 6612 method index: 7167
         return zpp_inner_zn.options.outer;
      }
      
      public function get handler() : Function
      {
         // method body index: 6613 method index: 7168
         return zpp_inner_zn.handler;
      }
   }
}
